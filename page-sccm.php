        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>Administering System Center Configuration Manager (SCCM) </h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>4775 Ratings (4.8)</p>
                    </div>
                    <p class="para">This course describes how to use Configuration Manager and its associated site systems to efficiently manage network resources. In this course, you will learn day-to-day management tasks, including how to manage applications, client health, hardware and software inventory, operating system deployment, and software updates by using Configuration Manager. You also will learn how to optimize System Center Endpoint Protection, manage compliance, and create management queries and reports. Additionally, this course, in conjunction with Microsoft Official Course 20703-2B, helps certification candidates prepare for Exam 70-703: Administering System Center Configuration Manager and Cloud Services Integration.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/sccm.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/sccm.jpg" alt="sccm">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>This course describes how to use Configuration Manager and its associated site systems to efficiently manage network resources. In this course, you will learn day-to-day management tasks, including how to manage applications, client health, hardware and software inventory, operating system deployment, and software updates by using Configuration Manager. You also will learn how to optimize System Center Endpoint Protection, manage compliance, and create management queries and reports. Additionally, this course, in conjunction with Microsoft Official Course 20703-2B, helps certification candidates prepare for Exam 70-703: Administering System Center Configuration Manager and Cloud Services Integration. </p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Managing computers and mobile devices in the enterprise </h6>
                            <ul>
                                <li>Overview of systems management by using enterprise management solutions </li>
                                <li>Overview of the Configuration Manager architecture </li>
                                <li>SOverview of the Configuration Manager administrative tools </li>
                                <li>Tools for monitoring and troubleshooting a Configuration Manager site </li>
                            </ul>
                            <h6>Lab : Exploring the Configuration Manager tools </h6>
                            <ul>
                            ...
                            <h6>Analyzing data using queries, reports, and CMPivot </h6>
                            <ul>
                            ...
                            <h6>Lab : Creating and running queries </h6>
                            <ul>
                                <li>Creating data queries </li>
                                <li>Creating subselect queries </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/sccm.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <p>Before attending this course, participants must have: </p>
                            <ul>
                                ...
                                <li>Active Directory Domain Services (AD DS) principles and fundamentals of AD DS management</li>
                                <li>Installation, configuration, and troubleshooting for Windows-based personal computers</li>
                                <li>Basic concepts of public key infrastructure (PKI) security</li>
                                <li>Basic understanding of scripting and Windows PowerShell syntax</li>
                                <li>Basic understanding of Windows Server roles and services</li>
                                <li>Basic understanding of the configuration options foriOS, Android, and Windows Mobile device platforms</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>This course is for experienced information technology (IT) professionals, typically described as Enterprise Desktop Administrators (EDAs). These EDAs deploy, manage, and maintain PCs, devices, and applications across medium, large, and enterprise organizations. A significant portion of this audience uses, or intends to use, the latest release of Configuration Manager to manage and deploy PCs, devices, and applications</li>
                            <li>This course also is for individuals who are interested in taking Exam 70-703: Administering System Center Configuration Manager and Cloud Services Integration. Courses 20703-1B and 20703-2B, or equivalent knowledge and skills, are necessary to prepare for this exam</li>
                        </ul>
                    </div>
                </div>
            </div>
