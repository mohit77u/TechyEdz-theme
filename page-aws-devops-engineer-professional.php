            ...
            <div class="col-sm-8">
                <div class="course-details">
                    ...
                    <div class="ratings">
                        ...
                        <p>2150 Ratings (4.9)</p>
                    </div>
                    <p class="para">The AWS Certified DevOps Engineer - Professional (DOP-CO1) examination validates technical expertise in provisioning, operating, and managing distributed application systems on the AWS platform. It is intended for individuals who perform a devops engineer role.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/aws-devops-engineer-professional.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/aws-devops-engineer-professional.jpg" alt="aws-devops-engineer-professional">
            </div>
        </div>
    </div>
</section>
...
<main>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>The AWS Certified DevOps Engineer - Professional (DOP-CO1) examination validates technical expertise in provisioning, operating, and managing distributed application systems on the AWS platform. It is intended for individuals who perform a devops engineer role.</p>
                    ...
                    <div class="content">
                        ...
                        <div class="topic-content">
                            ...
                            <ul>
                                ...
                                <li>What is SDLC?</li>
                                <li>Diff b/w agile & waterfall</li>
                                <li>DevOps and agile</li>
                                <li>DevOps Functionalities and tools</li>
                                <li>What is meant by DevOps?</li>
                                <li>What are the advantages to choose AWS DevOps?</li>
                                <li>Difference Between Agile and DevOps Methodology</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            ...
                            <ul>
                                ...
                                <li>Types of version controls</li>
                                <li>Diff b/w CVS & DVS</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Jenkins (Integration Tool)</h6>
                            <ul>
                                <li>Installation of Jenkins</li>
                                <li>How to create CI-CD pipeline?</li>
                                <li>Complete Lab Setup for Jenkins</li>
                                <li>How to install and create Plugins?</li>
                                <li>How to deploy into the Production?</li>
                                <li>How to analyze Whether Reports?</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Installation of GIT</h6>
                            <ul>
                                <li>Installation in windows</li>
                                <li>Installation in centos</li>
                                <li>Installation in Ubuntu</li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/aws-devops-engineer-professional.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="like">
        <div class="container">
            ...
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/aws-devops-engineer-professional.jpg" alt="aws-developer-associate">
            </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>One or more years of hands-on experience in Linux and Networking Knowledge</li>
                                ...
                                <li>Experience building highly automated infrastructures</li>
                                <li>Experience administering operating systems</li>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>Developers / Tester / Administrators / Architect</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h3>Certification</h3>
                    <p>AWS Certified DevOps Engineer – Professional (DOP-C01)</p>
                </div>
            </div>
        </div>
    </section>
