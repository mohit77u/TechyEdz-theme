            ...
            <div class="col-sm-8">
                <div class="course-details">
                    ...
                    <div class="ratings">
                        ...
                        <p>1750 Ratings (4.2)</p>
                    </div>
                    <p class="para">This AWS Certified Developer - Associate (DVA-C01) examination is intended for individuals who perform a developer role. This course for intermediate-level students begins with an overview of the fundamentals of Cloud computing, then moves you through an in-depth curriculum on developing, deploying, and maintaining applications — especially Serverless ones — on AWS.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/aws-developer-associate.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/aws-developer-associate.png" alt="aws-developer-associate">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>This AWS Certified Developer - Associate (DVA-C01) examination is intended for individuals who perform a developer role. This course for intermediate-level students begins with an overview of the fundamentals of Cloud computing, then moves you through an in-depth curriculum on developing, deploying, and maintaining applications — especially Serverless ones — on AWS.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Deployment</h6>
                            <ul>
                                <li>Deploy written code in AWS using existing CI/CD pipelines, processes, and patterns</li>
                        ...
                        <div class="topic-content">
                            ...
                            <ul>
                                ...
                                <li>Implement application authentication, and authorization</li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/aws-developer-associate.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>An AWS CCP or CSA-A certification is preferred, but not required</li>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>Existing developers, Systems Engineers, SysOps Engineers, DevOPs Engineers, Architects</li>
                            <li>People interested in hosting highly scaleable, fault tolerant applications on the AWS cloud</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h3>Certification</h3>
                    <p>AWS Certified Developer – Associate (DVA-C01)</p>
                </div>
            </div>
        </div>
    </section>
