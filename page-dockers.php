        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>Dockers Certification Training </h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>4175 Ratings (4.6)</p>
                    </div>
                    <p class="para">In this Docker training course teaches attendees how to leverage the core features of Docker including container creation and management, interacting with Docker hub, using Dockerfile to create and manage custom images, and much more. Students also learn best practices and build an application using Docker, Git, and a continuous integration server to automate the testing of containerized applications.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/dockers.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/dockers.jpg" alt="dockers">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>In this Docker training course teaches attendees how to leverage the core features of Docker including container creation and management, interacting with Docker hub, using Dockerfile to create and manage custom images, and much more. Students also learn best practices and build an application using Docker, Git, and a continuous integration server to automate the testing of containerized applications.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Container Technology Overview</h6>
                            <ul>
                                <li>Instructor Docker Demo </li>
                                <li>Application Management Landscape </li>
                                <li>Application Isolation </li>
                                <li>Resource Measurement and Control </li>
                                <li>Container Security </li>
                                <li>OverlayFS Overview </li>
                                <li>Container Security </li>
                                <li>Open Container Initiative </li>
                                <li>Docker Alternatives </li>
                                <li>Docker Ecosystem </li>
                                <li>Docker Ecosystem (cont.) </li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Installing Docker </h6>
                            <ul>
                                <li>Installing Docker </li>
                                <li>Docker Architecture </li>
                                <li>Starting the Docker Daemon </li>
                                <li>Docker Daemon Configuration </li>
                                <li>Docker Control Socket </li>
                                <li>Enabling TLS for Docker </li>
                                <li>Validating Docker Install </li>
                            </ul>
                            <h6>Managing Containers </h6>
                            <ul>
                                <li>Creating a New Container </li>
                                <li>Listing Containers </li>
                                <li>Managing Container Resources</li>
                                <li>Running Commands in an Existing Container </li>
                                <li>Interacting with a Running Container </li>
                                <li>Stopping, Starting, and Removing Containers </li>
                                <li>Copying files in/out of Containers </li>
                                <li>Inspecting and Updating Containers </li>
                                <li>Docker Output Filtering & Formatting </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/dockers.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>Should have proficiency with the Linux CLI and a broad understanding of Linux system administration</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>All IT professionals who actively develop, test, and/or deploy code </li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h3>Certification</h3>
                    <p>Docker Certified Associate (DCA) </p>
                </div>
            </div>
        </div>
    </section>
