        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>HP SAN Certified Professional </h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>4505 Ratings (4.6)</p>
                    </div>
                    <p class="para">This level of certification measures the competencies required for handson planning and the integration and support of technical solutions in business class, networked environments. Given a set of customer business requirements, this individual is expected to be able to design, support and integrate platform, operating system, storage, network and option components to solve business needs. The ideal candidate is anyone who deploys business class solutions based on HP technologies.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/hp-san-certified-professional.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                ...
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>SAN Concepts </h6>
                            <ul>
                                <li>Describe the purpose, features, and functions of a SAN</li>
                                <li>Identify basic and advanced SAN concepts (tiering, fabric resiliency, SAN security, LAN-free backup, redundant fabric SANs, etc.) </li>
                                <li>Identify similarities and differences of SAN and NAS technologies</li>
                                <li>Describe the purpose, features, and functions of HP Adaptive Infrastructure</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>How to Design a SAN </h6>
                            <ul>
                                <li>Identify and describe the basics of designing a SAN </li>
                                <li>Identify the infrastructure requirements of a SAN</li>
                                <li>Explain how to design a SAN utilizing a phased approach</li>
                                <li>Identify the factors and performance considerations when designing a SAN</li>
                                <li>Describe the HP SAN philosophy</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>HP Infrastructure </h6>
                            <ul>
                                <li>Identify the industry vendors supported by HP</li>
                                <li>Discuss SAN infrastructure positioning</li>
                                <li>Identify and describe the HP SAN design rules on infrastructure</li>
                                <li>Distinguish between the B-Series, M-Series, and C-Series switches</li>
                                <li>Identify the multiprotocol routers supported by HP</li>
                                <li>Identify and describe heterogeneous and interoperable SAN fabrics</li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/hp-san-certified-professional.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                ...
                                <li>Linux Professional Institute Certification Level 1 </li>
                                <li>Novell Certified Administrator </li>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <p>This exam is for technical presales and installation & setup personnel who propose, design, deploy, configure and integrate SAN-based storage solutions. Examples of job roles: </p>
                        <ul>
                            <li>HP SAN Architect </li>
                            <li>Storage SA </li>
                        </ul>
                    </div>
                </div>
