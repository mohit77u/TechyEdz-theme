        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>Office 365 Administration and Troubleshooting </h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>4265 Ratings (4.9)</p>
                    </div>
                    <p class="para">This course that targets the needs of information technology (IT) professionals who take part in administering, configuring, troubleshooting, and operating Office 365 services, including its identities, dependencies, requirements, and supporting technologies. This course focuses on skills required to administer and troubleshoot Office 365 tenant and key services of Office 365, such as Exchange Online, SharePoint Online and Skype for Business and Teams. It also covers security and compliance features of Office 365.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/office-365-administration-and-troubleshooting.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/office-365-administration-and-troubleshooting.jpg" alt="office-365-administration-and-troubleshooting">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>This course that targets the needs of information technology (IT) professionals who take part in administering, configuring, troubleshooting, and operating Office 365 services, including its identities, dependencies, requirements, and supporting technologies. This course focuses on skills required to administer and troubleshoot Office 365 tenant and key services of Office 365, such as Exchange Online, SharePoint Online and Skype for Business and Teams. It also covers security and compliance features of Office 365.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Module 1: Office 365 services overview </h6>
                            <p>This module describes the features of Office 365 and identifies recent improvements to the service. It also identifies licensing options, describes the process of Office 365 tenant configuration, and lists appropriate Office 365 client options.</p>
                            <h6>Lessons </h6>
                            <ul>
                            ...
                            <h6>Lab : Office 365 services overview </h6>
                            <ul>
                                <li>Setting up Office 365 lab environment </li>
                                <li>Configuring Office 365 Services </li>
                            </ul>
                            <p>After completing this module, students will be able to: </p>
                            <ul>
                                <li>Describe Office 365 services</li>
                                <li>Explain Office 365 licensing options</li>
                                <li>Describe Office 365 tenant configuration. </li>
                                <li>Describe the available Office 365 clients</li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/office-365-administration-and-troubleshooting.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                ...
                                <li>Experience working with Microsoft Exchange Server 2013 or newer, Microsoft Lync 2013 Server or Skype for Business 2015 Server, and Microsoft SharePoint Server 2013 or newer is beneficial but not required</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>This course is intended for IT professionals and system administrators who want to learn about administration and troubleshooting techniques in Office 365</li>
                            <li>These professionals should have at least three years of experience working in their respective fields: ideally in the areas of system administration, network administration, and messaging</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h3>Certification</h3>
                    <p>Nutanix Certified Professional (NCP) </p>
                    <p>Nutanix Certified Advanced Professional (NCAP) </p>
                    <p>Nutanix Platform Expert (NPX) </p>
                </div>
            </div>
        </div>
    </section> -->
