        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>Citrix Virtual Apps and Desktops 7 Advanced Administration</h2>
                    <div class="ratings">
                        <div class="star">
                    ...
                    <p class="para">In the advanced troubleshooting section, you will learn techniques to investigate many of the common issues that can affect environment health. You’ll leave this course with a good understanding of how to manage more complex solutions such as multizone environments spanning multiple locations with configurations around StoreFront, the Delivery Controllers, and HDX.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/citrix-virtual-apps-and-desktops-7-advanced-administration.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/citrix-virtual-apps-and-desktops-7-advanced-administration.jpg" alt="citrix-virtual-apps-and-desktops-7-advanced-administration">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>In the advanced troubleshooting section, you will learn techniques to investigate many of the common issues that can affect environment health. You’ll leave this course with a good understanding of how to manage more complex solutions such as multizone environments spanning multiple locations with configurations around StoreFront, the Delivery Controllers, and HDX.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Implementing Redundancy and Scalability</h6>
                            <ul>
                                <li>StoreFront and Citrix Gateway </li>
                                <li>Site Infrastructure </li>
                                <li>Machines Running the Virtual Delivery Agent</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Managing a Virtual Apps and Desktops Environment with Multiple Locations Zones</h6>
                            <ul>
                                <li>VDA Registration in a Multi-Zone Environment </li>
                                <li>Zone Preference </li>
                                <li>Optimal Gateway Routing and Zones </li>
                                <li>Managing StoreFront Store Subscriptions in a MultiLocation Environment </li>
                                <li>StoreFront and Citrix ADC Branding </li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Implementing Backups and Disaster Recovery </h6>
                            <ul>
                                <li>Backups </li>
                        ...
                        <div class="topic-content">
                            <h6>Implementing Advanced Authentication Methods </h6>
                            <ul>
                                <li>Multi-factor Authentication - RADIUS & OTP </li>
                                <li>Multi-factor Authentication - Smart Card Authentication </li>
                                <li>Federated Authentication - ADFS, SAML, and FAS </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/citrix-virtual-apps-and-desktops-7-advanced-administration.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>Strong foundational knowledge of Citrix Virtual Apps and Desktops 7</li>
                                <li>CWS-215 Citrix Virtual Apps and Desktops 7 Administration On-Premises and in Citrix Cloud</li>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>IT Professionals familiar with Citrix Virtual Apps and Desktops 7 in an on-premises environment or Citrix Cloud looking to expand their Citrix Virtual Apps and Desktops skills to an advanced level</li>
                            <li>Potential students include administrators or engineers responsible for the Citrix Apps and Desktop 7 Site</li>
                        </ul>
                    </div>
                </div>
            </div>
