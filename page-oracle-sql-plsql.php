...
<main>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h4>SQL </h4>
                            <h6>Introduction to Oracle Database (SQL)</h6>
                            <ul>
                                <li>What is Database?</li>
                                <li>Why Oracle?</li>
                                <li>Introduction to SQL and SQL *Plus, More SQL*Plus Commands </li>
                                <li>The Data Dictionary </li>
                            </ul>
                            <h6>Data Query Language (DQL)</h6>
                            <ul>
                                <li>Categories of SQL Statements </li>
                                <li>Oracle Data types </li>
                            ...
                            <ul>
                                ...
                                <li>The CREATE Statement </li>
                                <li>The DROP Command </li>
                                <li>The ALTER Command </li>
                                <li>Practical examples </li>
                            </ul>
                        ...
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/oracle-sql-plsql.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="like">
        <div class="container">
            ...
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/oracle-sql-plsql.png" alt="oracle-sql-plsql">
            </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>Previous experience with at least one programming language </li>
                                <li>Database Design and Database Programming with SQL </li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>Students who wish to learn the techniques and tools to automate database application tasks </li>
                            <li>Students who possess basic mathematical, logical, and analytical problem-solving skills </li>
                            <li>Novice programmers, as well as those at advanced levels, to learning the PL/SQL programming language to an advanced level </li>
                        </ul>
                    </div>
                </div>
            </div>
