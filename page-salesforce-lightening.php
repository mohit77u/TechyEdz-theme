        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>Salesforce Certification Training </h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>4475 Ratings (4.7)</p>
                    </div>
                    <p class="para">This Salesforce course is designed to ensure that you learn and master the concepts of being a Salesforce Administrator and App Builder. In this Salesforce training, you will learn how to configure Salesforce to collect, analyze, and retrieve vital customer information and create applications using Salesforce Lightning. This Salesforce training course is fully immersive and helps you clear the Salesforce Administrator Exam (ADM 201) and the Salesforce App Builder (DEV 401) Exam.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/salesforce-lightening.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/salesforce-lightening.png" alt="salesforce-lightening">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>This Salesforce course is designed to ensure that you learn and master the concepts of being a Salesforce Administrator and App Builder. In this Salesforce training, you will learn how to configure Salesforce to collect, analyze, and retrieve vital customer information and create applications using Salesforce Lightning. This Salesforce training course is fully immersive and helps you clear the Salesforce Administrator Exam (ADM 201) and the Salesforce App Builder (DEV 401) Exam. </p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h5>Lightning</h5>
                            <h6>Introduction to Lightning </h6>
                            <ul>
                                <li>Introduction to Salesforce Lightning Platform </li>
                            </ul>
                            <h6>Working on Classic To Lightning Migration </h6>
                            <ul>
                                <li>About previous user experience
                                    <ul>
                                        <li>Check list before moving to lightning experience </li>
                                        <li>Rolling out to lightning experience </li>
                                    </ul>
                                </li>
                            </ul>
                            <h6>Lightning Experience Basic </h6>
                            <ul>
                                <li>Get Started with Lightning </li>
                                <li>Decide When Lightning Experience Is Right for Your Company </li>
                                <li>Enable Lightning Experience </li>
                                <li>Disable switch between lightning experience and Salesforce classic </li>
                            </ul>
                            <h6>Administrator </h6>
                            <ul>
                                <li>Type of page assignment </li>
                                <li>Lightning App Builder </li>
                                <li>App Launcher </li>
                                <li>Object Manager </li>
                                <li>Global Search </li>
                                <li>Compact Layouts </li>
                                <li>Sales Cloud Features in lightning </li>
                                <li>Reports And Dashboards In lightning </li>
                                <li>Lightning App Builder </li>
                                <li>Domain </li>
                                <li>Need of Custom Domain </li>
                                <li>Lightning Process Builder </li>
                                <li>Service Cloud Features </li>
                                <li>Need Of Custom Domain </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/salesforce-lightening.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>There are no such prerequisites for this Salesforce.com training course. But prior working experience as an administrator or a developer is beneficial</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>Salesforce Professionals, Software Administrators, Developers, Analysts, Sales Managers and Executives can take this Salesforce course. </li>
                            <li>The Sales force Administrator training course is best suited for the following IT Professionals </li>
                            <li>System Administrators </li>
                            <li>IT Managers </li>
                            <li>Product Managers </li>
                            <li>Consultants </li>
                            <li>Sales Operations Professionals </li>
                            <li>Power Users </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h3>Certification</h3>
                    <p>(ADM 201) and the Salesforce App Builder (DEV 401) </p>
                </div>
            </div>
        </div>
    </section>
