        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>Machine Learning with Python Training</h2>
                    <div class="ratings">
                        <div class="star">
                    ...
                    <p class="para">Machine learning is the science of getting computers to act without being explicitly programmed. In the past decade, machine learning has given us self-driving cars, practical speech recognition, effective web search, and a vastly improved understanding of the human genome. Machine learning is so pervasive today that you probably use it dozens of times a day without knowing it. Many researchers also think it is the best way to make progress towards human-level AI. In this class, you will learn about the most effective machine learning techniques, and gain practice implementing them and getting them to work for yourself.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/machine-learning.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/machine-learning.jpg" alt="machine-learning">
            </div>
        </div>
    </div>
</section>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Python for Machine Learning</h6>
                            <ul>
                                <li>Programming Basics</li>
                                <li>Python Data Types</li>
                                <li>Structures and conditional statements</li>
                                <li>Python core packages</li>
                                <li>Introduction to Jupyter Notebook</li>
                                <li>Introduction to Numpy and Pandas</li>
                                <li>Data filtering and selecting</li>
                                <li>Find duplicates and treating missing values</li>
                                <li>Concatenate and transform data</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Setting up and installations</h6>
                            <ul>
                                <li>Installing python</li>
                                <li>Setting up Python environment for development</li>
                                <li>Installation of Jupyter Notebook</li>
                                <li>How to access our course material</li>
                                <li>Write your first program in python</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Python object and data structures operations</h6>
                            <ul>
                                <li>Introduction to Python objects</li>
                                <li>Number objects and operations</li>
                                <li>Variable assignment and keywords</li>
                                <li>String objects and operations</li>
                                <li>Print formatting with strings</li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/machine-learning.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>Familiarity with Python programming is also beneficial. You should understand these fundamental courses including Python for Data Science, Math Refresher, and Statistics Essential for Data Science, before getting into the Machine Learning course</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>Developers aspiring to be data scientists or machine learning engineers</li>
