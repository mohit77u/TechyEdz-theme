        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>Azure - Designing an Azure Data Solution (DP-201)</h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>3195 Ratings (4.4)</p>
                    </div>
                    <p class="para">This Learning Path is designed to help you and your team prepare for Microsoft's DP-201 Designing an Azure Data Solution exam. Even if you don't plan to take the exam, these courses and hands-on labs will help you learn how to design a variety of Azure data solutions.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/azure-data-engineer-dp-201.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/azure-data-engineer-dp-201.png" alt="azure-data-engineer-dp-201">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>This Learning Path is designed to help you and your team prepare for Microsoft's DP-201 Designing an Azure Data Solution exam. Even if you don't plan to take the exam, these courses and hands-on labs will help you learn how to design a variety of Azure data solutions.</p>
                            <p>Candidates who pass both the DP-200 and DP-201 exams will earn the Microsoft Certified: Azure Data Engineer Associate certification.</p>
                            <p>The DP-201 exam tests your knowledge of three subject areas: designing data storage solutions, designing data processing solutions, and designing for data security and compliance.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Recommend an Azure data storage solution based on requirements</h6>
                            <ul>
                                <li>choose the correct data storage solution to meet the technical and business requirements</li>
                                <li>choose the partition distribution type</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Design non-relational cloud data stores</h6>
                            <ul>
                                <li>design data distribution and partitions</li>
                                <li>design for scale (including multi-region, latency, and throughput)</li>
                                <li>design a solution that uses Cosmos DB, Data Lake Storage Gen2, or Blob storage</li>
                                <li>select the appropriate Cosmos DB API</li>
                                <li>design a disaster recovery strategy</li>
                                <li>design for high availability</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Design relational cloud data stores</h6>
                            <ul>
                                <li>design data distribution and partitions</li>
                                <li>design for scale (including latency, and throughput)</li>
                                <li>design a solution that uses Azure Synapse Analytics</li>
                                <li>design for high availability</li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/azure-data-engineer-dp-201.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                ...
                                <li>People preparing for Microsoft’s DP-201 exam</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            ...
                            <li>People who want to become Azure data engineers</li>
                            <li>People preparing for Microsoft’s DP-201 exam</li>
                        </ul>
                    </div>
                </div>
