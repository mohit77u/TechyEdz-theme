                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>Welcome to the world of Apple’s mobile platform, you must be here to learn about the basics of iOS development. Here we will give you a guide to learn the process from the ground all the way to an experienced developer. With time and dedication, you can make it happen on your own, just make sure not to give it up before the finish line. iOS App Development Basics, the second course in the iOS App Development with Swift specialization, expands your programming skills and applies them to authentic app development projects. The topics covered in this course include Xcode basics, Core iOS and Cocoa Touch frameworks, simple user interface creation, MVC Architecture and much more. With a focus on using Apple’s components to access sensors like camera, microphone and GPS, by the end of this course you will be able to create a basic App according to specified parameters and guidelines.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Introduction </h6>
                            <ul>
                                <li>iPhone and iPad Device Anatomy </li>
                                <li>iOS Architecture and SDK Frameworks </li>
                                <li>iOS and SDK Version Compatibility </li>
                                <li>Apple iOS Developer Program </li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Xcode 5 </h6>
                            <ul>
                                <li>Tour of the IDE </li>
                                <li>Templates, Projects, and Workspaces </li>
                                <li>Creating a New Project </li>
                                <li>LLVM and LLDB </li>
                                <li>Debug Gauges </li>
                                <li>Asset Management </li>
                                <li>XCTest Testing Framework </li>
                                <li>Continuous Integration and Bots </li>
                                <li>Automatic Configuration </li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Objective-C for Experienced Programmers </h6>
                            <ul>
                                ...
                                <li>Formal and Informal Protocols </li>
                                <li>Blocks </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/ios-app-development.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>This course assumes prior programming experience. Specifically, you should have a strong understanding of programming concepts like variables, if statements, loops, functions, and classes</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>Web developers interested in expanding their skillset to iOS app development </li>
                            <li>Mobile developers who want to enrich their portfolio of apps using the Swift programming language </li>
                            <li>Professionals and students who wish to learn iOS app development </li>
                            <li>Entrepreneurs or soon-to-be entrepreneurs who want to build a working app prototype in iOS and validate their ideas </li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h3>Certification</h3>
                    <p>Cloudera Certified Professional ( CCP ) Data Engineer </p>
                </div>
            </div>
        </div>
    </section>
