            ...
            <div class="col-sm-8">
                <div class="course-details">
                    ...
                    <div class="ratings">
                        ...
                        <p>4175 Ratings (4.2)</p>
                    </div>
                    <p class="para">You will be introduced to Google's best practices to protect your users and data. You will examine user and application security and become familiar with the Single Sign On (SSO) options available for your organization. You will be able to use the tools provided to identify security events and risks and mitigate problems that may arise.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/g-suite-admin-console.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/g-suite-admin-console.png" alt="g-suite-admin-console">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>This specialization has been developed to help administrators master the foundations of establishing and managing G Suite for their organization.</p>
                            <p>You will setup a new G Suite account, and explore provisioning options. You will learn how to manage users and become familiar with organizational structures and core services such as Gmail and Calendar. You will learn how to configure these services to meet your own needs for different parts of the organization.</p>
                            <p>You will be introduced to Google's best practices to protect your users and data. You will examine user and application security and become familiar with the Single Sign On (SSO) options available for your organization. You will be able to use the tools provided to identify security events and risks and mitigate problems that may arise.</p>
                            <p>You will configure email compliance and implement measures to protect your organization from spam, spoofing, phishing and malware attacks. You will also become familiar with the various mail routing options available.</p>
                            <p>Finally, you will learn Google’s best practices for deploying G Suite into your organization.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Let’s Start with G Suite </h6>
                            <ul>
                                <li>Why G Suite? and What is G Suite? </li>
                                <li>Admin Console overview </li>
                                <li>DNS Configuration(MX,SPF,DKIM and DMARC) </li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            ...
                            <ul>
                                ...
                                <li>Bulk Upload using Admin and Third-Party Tool </li>
                                <li>Managing Users, restore data, restore user, reset password etc </li>
                                <li>Admin Roles and Custom Admin </li>
                            </ul>
                            <h6>Google Groups </h6>
                            <ul>
                                <li>Overview of Google Groups </li>
                                <li>Manage Members </li>
                                <li>Group Settings (Moderation, Posting, Auto Reply etc) </li>
                                <li>Google Groups Tricks(No Email, Allow Posting for particular users) </li>
                            </ul>
                            <h6>Organizations Unit </h6>
                            <ul>
                                <li>Importance of organizations Unit </li>
                                <li>Control using OU </li>
                                <li>OU Structure </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/g-suite-admin-console.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>Any one can attend this course </li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h3>Certification</h3>
                    <p>GCP Professional Machine Learning Engineer (GCP MLE ) </p>
                </div>
            </div>
        </div>
    </section> -->
