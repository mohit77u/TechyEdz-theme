        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>Salesforce Apex and Visualforce </h2>
                    <div class="ratings">
                        <div class="star">
                    ...
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/salesforce-apex-visualforce.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/salesforce-apex-visualforce.jpg" alt="salesforce-apex-visualforce">
            </div>
        </div>
    </div>
</section>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h5>Apex and Visualforce </h5>
                            <h6>Declarative Automation </h6>
                            <ul>
                                <li>Creating Formula Fields </li>
                                <li>Creating Roll-Up Summary Fields </li>
                                <li>Understanding Record Types </li>
                                <li>Review Other Automation Tools </li>
                                <li>Building a Data Model on the Salesforce Platform </li>
                            </ul>
                            <h6>Programming with Apex </h6>
                            <ul>
                            ...
                            <h6>Use SOQL and SOSL to Retrieve Your Org’s Data </h6>
                            <ul>
                                ...
                                <li>Write a query that traverses a parent-to-child relationship </li>
                                <li>Use SOSL to Search Data </li>
                            </ul>
                            <h6>Using DML to Manipulate Your Org’s Data </h6>
                            <ul>
                        ...
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/salesforce-apex-visualforce.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
