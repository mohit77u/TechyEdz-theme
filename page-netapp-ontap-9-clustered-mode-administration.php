        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>NetApp Data ONTAP 9 CLUSTERED MODE ADMINISTRATION </h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>4565 Ratings (4.4)</p>
                    </div>
                    <p class="para">In this instructor-led course uses lecture and hands-on exercises to teach the basic administration tasks of an ONTAP 9.6 cluster. You use the cluster shell and ONTAP System Manager to manage storage and network resources. ONTAP Cluster Administration is an intermediate course in a comprehensive learning path for NetApp customers, partners, and employees. This course is generally taught with the two-day ONTAP Data Protection course.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/netapp-ontap-9-clustered-mode-administration.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/netapp-ontap-9-clustered-mode-administration.jpg" alt="netapp-ontap-9-clustered-mode-administration">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>In this instructor-led course uses lecture and hands-on exercises to teach the basic administration tasks of an ONTAP 9.6 cluster. You use the cluster shell and ONTAP System Manager to manage storage and network resources. ONTAP Cluster Administration is an intermediate course in a comprehensive learning path for NetApp customers, partners, and employees. This course is generally taught with the two-day ONTAP Data Protection course.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>NetApp ONTAP 9 Clusters </h6>
                            <ul>
                                <li>ONTAP deployment options </li>
                                <li>The cluster </li>
                                <li>SVMs</li>
                                <li>ONTAP select learning resources </li>
                                <li>NetApp cloud volumes learning resources </li>
                            </ul>
                            <h6>Cluster Setup </h6>
                            <ul>
                                <li>Supported FAS and AFF configurations </li>
                                <li>Cluster setup </li>
                                <li>Administration interfaces </li>
                                <li>OnCommand System Manager: Guided cluster setup </li>
                            </ul>
                            <h6>Cluster Management </h6>
                            <ul>
                                <li>Manage access control </li>
                                <li>Cluster node date and time </li>
                                <li>ONTAP software licenses </li>
                                <li>Manage jobs and schedules </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/netapp-ontap-9-clustered-mode-administration.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>ONTAP Cluster Fundamentals (WBT]) </li>
                                <li>ONTAP NAS Fundamentals (WBT) </li>
                                <li>ONTAP SAN Fundamentals (WBT) </li>
                            </ul>
                        </div>
                    </div>
                </div>
