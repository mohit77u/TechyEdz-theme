        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>Azure Data Science Solution (DP-100)</h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>3235 Ratings (4.2)</p>
                    </div>
                    <p class="para">This learning path is designed to help you prepare for Microsoft's DP-100 Designing and Implementing a Data Science Solution on Azure exam. Even if you don't plan to take the exam, these courses and hands-on labs will help you learn how to use Azure's machine learning solutions.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/azure-data-science-solution-dp-100.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/azure-data-science-solution-dp-100.png" alt="azure-data-science-solution-dp-100">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>This learning path is designed to help you prepare for Microsoft's DP-100 Designing and Implementing a Data Science Solution on Azure exam. Even if you don't plan to take the exam, these courses and hands-on labs will help you learn how to use Azure's machine learning solutions.</p>
                            <p>Candidates who pass the DP-100 exam will earn the Microsoft Certified: Azure Data Scientist Associate certification.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Create an Azure Machine Learning workspace</h6>
                            <ul>
                        ...
                        <div class="topic-content">
                            <h6>Manage data objects in an Azure Machine Learning workspace</h6>
                            <ul>
                                <li>register and maintain data stores</li>
                                <li>create and manage datasets</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Manage experiment compute contexts</h6>
                            <ul>
                                <li>create a compute instance</li>
                                <li>determine appropriate compute specifications for</li>
                                <li>dcreate compute targets for experiments and training</li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/azure-data-science-solution-dp-100.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>Basic experience using Microsoft Azure</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <p>The Azure Data Scientist applies their knowledge of data science and machine learning to implementing and running machine learning workloads on Azure; in particular, using Azure Machine Learning Service. This entails planning and creating a suitable working environment for data science workloads on Azure, running data experiments and training predictive models, managing and optimizing models, and deploying machine learning models into production.</p>
                    </div>
                </div>
            </div>
        </div>
