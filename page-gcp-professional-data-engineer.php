        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>GCP Professional Data Engineer </h2>
                    <div class="ratings">
                        <div class="star">
                    ...
                    <p class="para">A Professional Data Engineer enables data-driven decision making by collecting, transforming, and publishing data. A Data Engineer should be able to design, build, operationalize, secure, and monitor data processing systems with a particular emphasis on security and compliance; scalability and efficiency; reliability and fidelity; and flexibility and portability. A Data Engineer should also be able to leverage, deploy, and continuously train pre-existing machine learning models.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/gcp-professional-data-engineer.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/gcp-professional-data-engineer.jpg" alt="gcp-professional-data-engineer">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>A Professional Data Engineer enables data-driven decision making by collecting, transforming, and publishing data. A Data Engineer should be able to design, build, operationalize, secure, and monitor data processing systems with a particular emphasis on security and compliance; scalability and efficiency; reliability and fidelity; and flexibility and portability. A Data Engineer should also be able to leverage, deploy, and continuously train pre-existing machine learning models.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h4>Designing data processing systems </h4>
                            <h6>Selecting the appropriate storage technologies </h6>
                            <ul>
                                <li>Mapping storage systems to business requirements </li>
                                <li>Data modeling </li>
                                <li>Tradeoffs involving latency, throughput, transactions </li>
                                <li>Distributed systems </li>
                                <li>Schema design </li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Designing data pipelines </h6>
                            <ul>
                                <li>Data publishing and visualization (e.g., BigQuery) </li>
                                <li>Batch and streaming data (e.g., Cloud Dataflow, Cloud Dataproc, Apache Beam, Apache Spark and Hadoop ecosystem, Cloud Pub/Sub, Apache Kafka) </li>
                                <li>Online (interactive) vs. batch predictions </li>
                                <li>Job automation and orchestration (e.g., Cloud Composer) </li>
                            </ul>
                            <h6>Designing a data processing solution </h6>
                            <ul>
                                <li>Choice of infrastructure </li>
                                <li>System availability and fault tolerance </li>
                                <li>Use of distributed systems </li>
                                <li>Capacity planning </li>
                                <li>Hybrid cloud and edge computing </li>
                                <li>Architecture options (e.g., message brokers, message queues, middleware, service-oriented architecture, serverless functions) </li>
                                <li>At least once, in-order, and exactly once, etc., event processing </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/gcp-professional-data-engineer.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>If you’re already a data scientist, a data engineer, data analyst, machine learning engineer or looking for a career change into the world of data, the Google Cloud Professional Data Engineer Certification is for you</li>
                                <li>Being able to use cloud technologies is becoming a requirement for any kind of data focused role</li>
                                <li>Learners should be familiar with the fundamentals of cloud computing and relevant practical experience</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>Google recommends 3+ years of industry experience and 1+ years designing and managing solutions using GCP for professional level certifications</li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h3>Certification</h3>
                    <p>GCP Professional Cloud Collaboration Engineer (GCP PDE ) </p>
                </div>
            </div>
        </div>
    </section>
