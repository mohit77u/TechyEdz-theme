        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>Splunk Admin, Development & SIEM Certification Training </h2>
                    <div class="ratings">
                        <div class="star">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h5>Splunk Admin </h5>
                            <h6>Splunk Admin Basics </h6>
                            <ul>
                                <li>Identify Splunk components </li>
                            </ul>
                            <h6>License Management </h6>
                            <ul>
                                <li>Identify license types </li>
                                <li>Understand license violations </li>
                            </ul>
                            <h6>Splunk Configuration Files </h6>
                            <ul>
                                <li>Describe Splunk configuration directory structure </li>
                                <li>Understand configuration layering </li>
                                <li>Understand configuration precedence </li>
                                <li>Use btool to examine configuration settings </li>
                            </ul>
                            <h6>Splunk Indexes </h6>
                            <ul>
                                <li>Describe index structure </li>
                                <li>List types of index buckets </li>
                                <li>Check index data integrity </li>
                                <li>Describe indexes.conf options </li>
                                <li>Describe the fishbucket </li>
                                <li>Apply a data retention policy </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/splunk-admin-development-siem.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>Splunk Fundamentals 1 </li>
                                <li>Splunk Fundamentals 2</li>
                                <li>Before taking this course, students should have experience and knowledge of basic web development fundamentals (HTML, CSS, Javascript)</li>
                                <li>Basic knowledge in SQL queries and command line interface</li>
                                <li>Knowledge of Data Analytics concepts is beneficial but not essential</li>
                                <li>Must have good knowledge of system administration</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>Splunk classes are designed for specific roles such as Splunk Administrator, Developer, User, Knowledge Manager, or Architect</li>
                            <li>The “Splunk Developer” course is targeted for Splunk users that want to create custom apps and visualizations in Splunk</li>
                            <li>Individual Contributors/Architects willing to implement Splunk in their organizations </li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h3>Certification</h3>
                    <p>ServiceNow Certified Application Developer (CAD) </p>
                </div>
            </div>
        </div>
    </section> -->
