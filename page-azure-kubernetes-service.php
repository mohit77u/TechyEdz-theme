            ...
            <div class="col-sm-8">
                <div class="course-details">
                    ...
                    <div class="ratings">
                        ...
                        <p>1535 Ratings (4.3)</p>
                    </div>
                    <p class="para">Azure Kubernetes Service Zero to Hero admin guide is an intermediate course which describes: Comparison of Managed vs self-managed Kubernetes solutions, Comparison of Managed vs self-managed Kubernetes solutions, AKS Capacity Analysis, Detailed AKS network architecture, etc.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/azure-kubernetes-service.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/azure-all.jpg" alt="azure-kubernetes-service">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <ul>
                                <li>What is Azure Kubernetes Service (AKS)</li>
                                <li>Managed vs self-managed Kubernetes solutions</li>
                                <li>AKS Capacity Analysis</li>
                                <li>Detailed AKS Network architecture</li>
                                <li>How to create an AKS cluster using Azure Portal and Azure CLI</li>
                                <li>AKS authentication and authorization, including integration with Active Directory</li>
                                <li>How AKS manages Azure storage volumes</li>
                                <li>AKS monitoring and log debugging</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Azure Kubernetes Service (AKS) Overview</h6>
                            <ul>
                                <li>What is AKS?</li>
                                <li>AKS pricing</li>
                            </ul>
                        ...
                        <div class="topic-content">
                            <h6>Managed vs Self Managed Kubernetes</h6>
                            <ul>
                                <li>The truth about managed Kubernetes services</li>
                                <li>The good about managed Kubernetes services</li>
                                <li>The bad about managed Kubernetes services</li>
                                <li>Managed vs Self Managed comparison</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>AKS Capacity Analysis</h6>
                            <ul>
                                <li>Regions availability</li>
                                <li>Restricted Virtual Machine Sizes</li>
                                <li>Resource Group and Tags</li>
                                <li>Node Operating System</li>
                                <li>Kubernetes version</li>
                                <li>Network</li>
                                <li>Resources reservation</li>
                                <li>Azure subscription limits</li>
                                <li>Resource Group limits</li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/azure-kubernetes-service.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>Familiarity with Azure Portal and Azure CLI</li>
                                <li>Understanding of Kubernetes objects, such as Namespaces, Pods and RBAC</li>
                                <li>Basic Bash and Linux command line knowledge</li>
                                <li>Understanding of network concepts</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>Fearless Kubernetes administrators</li>
                        </ul>
                    </div>
                </div>
            </div>
