            ...
            <div class="col-sm-8">
                <div class="course-details">
                    ...
                    <div class="ratings">
                        ...
                        <p>1965 Ratings (4.9)</p>
                    </div>
                    <p class="para">Apache Kafka is an open-source stream processing platform and a high-performance real-time messaging system that can process millions of messages per second. It provides a distributed and partitioned messaging system that is highly fault tolerant. This Kafka Training course will guide participants through Kafka architecture, installation, interfaces and configuration on their way to learning the advanced concepts of Big Data.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/apache-kafka.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/apache-kafka.jpg" alt="active-directory-services-with-windows-server">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>Apache Kafka is an open-source stream processing platform and a high-performance real-time messaging system that can process millions of messages per second. It provides a distributed and partitioned messaging system that is highly fault tolerant. This Kafka Training course will guide participants through Kafka architecture, installation, interfaces and configuration on their way to learning the advanced concepts of Big Data.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>CONFIGURATION</h6>
                            <ul>
                                <li>Broker Configs</li>
                                <li>Topic Configs</li>
                                <li>Producer Configs</li>
                                <li>Consumer Configs</li>
                                <li>Kafka Connect Configs</li>
                                <li>Kafka Streams Configs</li>
                                <li>AdminClient Configs</li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/apache-kafka.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>Knowledge of any messaging system</li>
                                <li>Basic knowledge of Java or any programming language</li>
                                <li>Some knowledge of Linux- or Unix-based systems (nor required)</li>
                            </ul>
                        </div>
                    </div>
                </div>
