                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>A Google Cloud certification in G Suite signals to employers that you possess the digital skills to work collaboratively and productively in a professional environment. By earning the G Suite certification, you prove your ability to complete common workplace activities using cloud-based tools to create and share documents, spreadsheets, presentations, and files. You demonstrate that you can communicate effectively with email and online meeting solutions.</p>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            ...
                            <ul>
                                <li>Copying </li>
                                <li>Moving to trash </li>
                                <li>Downloading to hard drive </li>
                                <li>Uploading from hard drive </li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Creating and managing folders </h6>
                            <ul>
                                <li>Moving</li>
                                <li>Renaming </li>
                                <li>Removing (moving to trash) </li>
                            </ul>
                            <h6>Locating files </h6>
                            <ul>
                                <li>Search </li>
                                <li>Recent </li>
                                <li>Shared with me </li>
                                <li>Computer and device sync settings </li>
                            </ul>
                            <h6>Changing display and settings. Settings include</h6>
                            <ul>
                                <li>Grid or list view </li>
                                <li>File or folder details </li>
                                <li>Offline accessibility </li>
                                <li>Notifications (adding content, delete a file) </li>
                                <li>Folder activity (for example, last modified date) </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/g-suite.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <p>Students should have basic knowledge of using computer</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>Anyone interested in learning Google G suite to improve personal and office productivity</li>
                        </ul>
                    </div>
                </div>
            </div>
