        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2> Microsoft Visio Training </h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>4395 Ratings (4.9)</p>
                    </div>
                    <p class="para">Visio is a drawing and diagramming program that includes a variety of pre-drawn shapes and picture elements that can be dragged and dropped onto the illustration. Users can define their own elements and place them onto the Visio palette. "Visio Home" is a version of Visio designed for personal use and includes elements for landscaping, family trees, decorating, etc.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/microsoft-visio.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/microsoft-visio.jpg" alt="microsoft-visio">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>Visio is a drawing and diagramming program that includes a variety of pre-drawn shapes and picture elements that can be dragged and dropped onto the illustration. Users can define their own elements and place them onto the Visio palette. "Visio Home" is a version of Visio designed for personal use and includes elements for landscaping, family trees, decorating, etc.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Getting Started with Visio 2016 </h6>
                            <ul>
                                <li>Perform Basic Tasks in the Visio Environment </li>
                                <li>Use Backstage Commands </li>
                                <li>Save a File </li>
                                <li>The Visio Drawing Window </li>
                                <li>Toolbars </li>
                                <li>Overview of Templates, Stencils and Shapes </li>
                                <li>Changing View Settings </li>
                            </ul>
                            <h6>Drawing Tools </h6>
                            <ul>
                                <li>Creating New Drawings </li>
                                <li>Drawing Closed Shapes </li>
                                <li>Drawing Open Shapes </li>
                                <li>Using the Freeform tool </li>
                                <li>Drawing Compound Lines </li>
                                <li>Finding Stencils and Shapes </li>
                            </ul>
                            <h6>Creating Basic Diagrams </h6>
                            <ul>
                                <li>Selection Techniques </li>
                                <li>Connecting Shapes </li>
                                <li>Moving and Deleting Shapes </li>
                                <li>Aligning Shapes </li>
                                <li>Distributing Shapes </li>
                                <li>Rotating Shapes </li>
                                <li>Grouping Shapes </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/microsoft-visio.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>A working knowledge of Windows is required, or our Microsoft Windows Introduction course. No experience of MS Visio is required</li>
                                <li>To ensure your success, you will need to be familiar with using personal computers and proficient in using Windows to access programs, navigate to information stored on the computer, and manage files and folders</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>Our Microsoft Visio introduction course is suitable for complete beginners to Microsoft Visio</li>
                            <li>This course is designed for persons who are new to Visio and who will be using Visio to create basic workflows and perform end-to-end flowcharting</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h3>Certification</h3>
                    <p>Microsoft Certified Technology Specialist (MCTS) </p>
                </div>
            </div>
        </div>
    </section>
