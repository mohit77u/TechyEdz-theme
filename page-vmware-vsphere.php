        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>VMware vSphere: Install, Configure, Manage [V6.7] </h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>4305 Ratings (4.5)</p>
                    </div>
                    <p class="para">This course features intensive hands-on training that focuses on installing, configuring, and managing VMware vSphere 6.7, which includes VMware ESX 6.7 and VMware vCenter Server 6.7. This course prepares you to administer a vSphere infrastructure for an organization of any size. It is the foundation for most other VMware technologies in the software-defined data centre.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/vmware-vsphere.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/vmware-vsphere.png" alt="vmware-vsphere">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>This course features intensive hands-on training that focuses on installing, configuring, and managing VMware vSphere 6.7, which includes VMware ESX 6.7 and VMware vCenter Server 6.7. This course prepares you to administer a vSphere infrastructure for an organization of any size. It is the foundation for most other VMware technologies in the software-defined data centre. </p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="content">
                        ...
                        <div class="topic-content">
                            ...
                            <ul>
                                ...
                                <li>Familiarize yourself with the benefits of the VMware Education Learning Zone </li>
                                <li>Identify additional resources </li>
                            </ul>
                            <h6>Introduction to vSphere and the Software-Defined Data Centre </h6>
                            <ul>
                                <li>Describe the topology of a physical data centre </li>
                                ...
                                <li>Define the purpose of vCentre Server </li>
                                <li>Explain the software-defined data centre </li>
                                <li>Describe private, public, and hybrid clouds </li>
                            </ul>
                            <h6>Creating Virtual Machines </h6>
                            <ul>
                        ...
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/vmware-vsphere.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                ...
                                <li>Basic Knowledge on Networking and Storage </li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>Systems Administrators & System Engineers </li>
                            <li>People who are looking forward to move their career in the Data centre Technologies</li>
                        </ul>
                    </div>
                </div>
            </div>
