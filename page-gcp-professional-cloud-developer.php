        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>GCP Professional Cloud Developer </h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>4475 Ratings (4.6)</p>
                    </div>
                    <p class="para">A Professional Cloud Developer builds scalable and highly available applications using Google-recommended practices and tools. This individual has experience with cloudnative applications, developer tools, managed services, and next-generation databases. A Professional Cloud Developer also has proficiency with at least one general-purpose programming language and is skilled at producing meaningful metrics and logs to debug and trace code.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/gcp-professional-cloud-developer.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/gcp-professional-cloud-developer.jpg" alt="gcp-professional-cloud-developer">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>A Professional Cloud Developer builds scalable and highly available applications using Google-recommended practices and tools. This individual has experience with cloudnative applications, developer tools, managed services, and next-generation databases. A Professional Cloud Developer also has proficiency with at least one general-purpose programming language and is skilled at producing meaningful metrics and logs to debug and trace code.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h4>Designing highly scalable, available, and reliable cloud-native applications </h4>
                            <h6>Designing high-performing applications and APIs</h6>
                            <ul>
                                <li>Microservices</li>
                                <li>Scaling velocity characteristics/tradeoffs of IaaS (infrastructure as a service) vs. CaaS (container as a service) vs. PaaS (platform as a service) </li>
                        ...
                        <div class="topic-content">
                            <h6>Designing secure applications</h6>
                            <ul>
                                ...
                                <li>Authenticating to Google services (e.g., application default credentials, JWT, OAuth 2.0) </li>
                        ...
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/gcp-professional-cloud-developer.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>This individual has proficiency with at least one general purpose programming language to define new APIs and invoke Google APIs and are skilled with using Stackdriver to produce meaningful metrics and logs to debug and trace code</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h3>Certification</h3>
                    <p>GCP Professional Cloud Developer (GCP PCD) </p>
                </div>
            </div>
        </div>
    </section>
