        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>Cisco Certified Network Professional (CCNP)</h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>3390 Ratings (4.9)</p>
                    </div>
                    <p class="para">The CCNP Routing, Switching & Troubleshooting certification is appropriate for those with at least one year of networking experience who are ready to advance their skills and work independently on complex network solutions. Those who achieve CCNP Routing and Switching have demonstrated the skills required in enterprise roles such as network engineer, support engineer, systems engineer or network technician.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/cisco-ccnp.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Implementing Cisco IP Routing (ROUTE)</h6>
                            <ul>
                                <li>Describing Routing Protocols</li>
                                <li>Implementing RIPng</li>
                                <li>Implementing EIGRP</li>
                                <li>Configure EIGRP for IPv6</li>
                                <li>Discovering Named EIGRP Configuration</li>
                                <li>Establishing OSPF</li>
                                <li>Optimizing OSPF Behavior</li>
                                <li>Configuring OSPFv3</li>
                                <li>Configuring Redistribution</li>
                                <li>Implementing Path Control</li>
                                <li>Establishing Internet Connectivity</li>
                                <li>Implementing BGP</li>
                                <li>Implementing BGP for IPv6</li>
                                <li>Securing Cisco Routers</li>
                                <li>Configuring EIGRP Authentication</li>
                                <li>Configuring OSPF and BGP Authentication</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Implementing Cisco IP Switched Networks (SWITCH)</h6>
                            <ul>
                                <li>SWITCH Introduction</li>
                                <li>Switch Architecture Concepts</li>
                                <li>Spanning Tree Protocol</li>
                                <li>First-Hop Redundancy and High Availability Features</li>
                                <li>Security Features</li>
                                <li>VLANs and Trunking</li>
                                <li>Services</li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/cisco-ccnp.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            ...
                            <ul>
                                <li>Valid Cisco CCNA Routing and Switching certification or any Cisco CCIE certification can act as a prerequisite</li>
