        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>Basic NetApp Configuration and Administration (BNCA) </h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>4065 Ratings (4.7)</p>
                    </div>
                    <p class="para">Learn how to configure the basic technologies of the NetApp Data ONTAP® operating system—clustered Data ONTAP and Data ONTAP operating in 7-Mode. Through lectures and hands-on exercises, learn how to create aggregates, storage virtual machines (SVMs), virtual interfaces (VIFs), FlexVol® volumes, qtrees, Snapshot® copies, and more.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/netapp-basic-configuration-and-administration.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/netapp-basic-configuration-and-administration.jpg" alt="netapp-basic-configuration-and-administration">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>Learn how to configure the basic technologies of the NetApp Data ONTAP® operating system—clustered Data ONTAP and Data ONTAP operating in 7-Mode. Through lectures and hands-on exercises, learn how to create aggregates, storage virtual machines (SVMs), virtual interfaces (VIFs), FlexVol® volumes, qtrees, Snapshot® copies, and more.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>ONTAP Cluster Fundamentals: Clusters </h6>
                            <ul>
                                ...
                                <li>ONTAP 9 software
                                    <ul>
                                        <li>Cluster </li>
                                        <li>Nodes</li>
                                        <li>High-Availability pairs </li>
                                        <li>Networks</li>
                                        <li>Ports and logical interfaces </li>
                                    </ul>
                                </li>
                                <li>ONTAP storage architecture 
                                    <ul>
                                        <li>Physical Storage </li>
                                        <li>Aggregates </li>
                                        <li>Logical storage </li>
                                        <li>SVM with FlexVol volumes </li>
                                        <li>Ports and logical interfaces </li>
                                    </ul>
                                </li>
                                <li>Cluster configurations </li>
                                <li>ONTAP 9 software deployments  
                                    <ul>
                                        <li>All Flash FAS and FAS </li>
                                        <li>FlexPod solution </li>
                                        <li>FlexArray virtualization </li>
                                        <li>ONTAP Select </li>
                                        <li>NetApp Provate Storage (NPS) </li>
                                        <li>ONTAP Cloud </li>
                                    </ul>
                                </li>
                                <li>Supported cluster configuration   
                                    <ul>
                                        <li>Single node </li>
                                        <li>2-note switchless </li>
                                        <li>Multimode switched </li>
                                        <li>MetroCluster</li>
                                    </ul>
                                </li>
                                <li>Create a cluster </li>
                            </ul>
                            <h6>ONTAP Cluster Fundamentals: Management </h6>
                            <ul>
                                <li>Administrators 
                                    <ul>
                                        <li>Cluster administrators </li>
                                        <li>SVM administrators </li>
                                    </ul>
                                </li>
                                <li>Accessing the cluster  
                                    <ul>
                                        <li>Command line interface (CLI) </li>
                                        <li>OnCommand System Manager </li>
                                    </ul>
                                </li>
                                <li>Managing clusters </li>
                                <li>Clustershell</li>
                                <li>System manager dashboard </li>
                                <li>OnCommand Management portfolio </li>
                                <li>Configuring clusters </li>
                                <li>Managing cluster access   
                                    <ul>
                                        <li>User accounts </li>
                                        <li>Access method </li>
                                        <li>User role </li>
                                ...
                                <li>Predefined SVM roles </li>
                                <li>Monitoring clusters    
                                    <ul>
                                        <li>AutoSupport </li>
                                        <li>OnCommand portfolio</li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/netapp-basic-configuration-and-administration.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>Storage Fundamentals WBT </li>
                                <li>Introduction to NetApp Products WBT </li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>NetApp customers, IT generalists, and academic alliance students </li>
                        </ul>
                    </div>
                </div>
            </div>
