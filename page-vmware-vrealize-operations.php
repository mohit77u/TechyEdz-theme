        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>VMware vRealize Operations: Install, Configure, Manage [V8] </h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>4805 Ratings (4.9)</p>
                    </div>
                    <p class="para">This course covers advanced capabilities like customizing alerts, views, reports, and dashboards and explains the architecture and different ways of deploying VMware vRealize® operations. This course explains certificates, capacity concepts, and workload optimization with real-world use cases and covers troubleshooting using dashboards and how-to manage compliance and configurations. The course also covers management packs such as those for or in the SDDC Management Health solution, Storage Devices Management Pack, and AWS Management Pack.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/vmware-vrealize-operations.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>This course covers advanced capabilities like customizing alerts, views, reports, and dashboards and explains the architecture and different ways of deploying VMware vRealize® operations. This course explains certificates, capacity concepts, and workload optimization with real-world use cases and covers troubleshooting using dashboards and how-to manage compliance and configurations. The course also covers management packs such as those for or in the SDDC Management Health solution, Storage Devices Management Pack, and AWS Management Pack. </p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            ...
                            <h6>User Interface Enhancements </h6>
                            <ul>
                            ...
                            <h6>Deploying vRealize Operations </h6>
                            <ul>
                                ...
                                <li>Describe how to use vRealize Lifecycle Manager to deploy vRealize Operations </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/vmware-vrealize-operations.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>System administration experience with VMware vSphere® deployments </li>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>Experienced system administrators, system integrators, and consultants responsible for designing, implementing, and customizing vRealize Operations </li>
