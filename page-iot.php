            ...
            <div class="col-sm-8">
                <div class="course-details">
                    ...
                    <div class="ratings">
                        ...
                        <p>5385 Ratings (4.5)</p>
                    </div>
                    <p class="para">Internet of Things (IoT) is a system of interrelated computing devices, mechanical and digital machines, objects, or people that are provided with unique identifiers and the ability to transfer data over a network without requiring human-to-human or human-tocomputer interaction. Students will learn about IoT introduction, significance, building your own IoT devices, sensors, IoT communication and security. The course introduces advanced concepts and methodologies of IoT to design, build and deploy IoT solutions. It also discusses various technologies and protocols used for communication including new generation IoTfriendly applications and physical layer protocols.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/iot.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/iot.jpg" alt="iot">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>Internet of Things (IoT) is a system of interrelated computing devices, mechanical and digital machines, objects, or people that are provided with unique identifiers and the ability to transfer data over a network without requiring human-to-human or human-tocomputer interaction. Students will learn about IoT introduction, significance, building your own IoT devices, sensors, IoT communication and security. The course introduces advanced concepts and methodologies of IoT to design, build and deploy IoT solutions. It also discusses various technologies and protocols used for communication including new generation IoTfriendly applications and physical layer protocols. Candidates will be able to get a thorough understanding of widely accepted IoT frameworks and standards. The course covers popular, service-rich cloud platforms and focuses on how to build and deploy IoT solutions. Practical use cases and case studies are included to ensure that the candidate develops an ability to work through practical real-life scenarios.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>What is Internet of Things (IoT)?</h6>
                            <ul>
                                <li>What is IoT, how does it work </li>
                                <li>Difference between Embedded device and IoT device </li>
                                <li>iProperties of IoT device </li>
                                <li>IoT Ecosystem </li>
                                <li>IoT Decision Framework </li>
                                <li>IoT Solution Architecture Models </li>
                                <li>How IoT is Transforming Businesses </li>
                                <li>Major IoT Boards in Market </li>
                                <li>Explore Raspberry Pi </li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Setting up Raspberry Pi and Sensors (HAT Board) </h6>
                            <ul>
                                <li>Setting up Raspberry Pi </li>
                                <li>Showing working of Raspberry Pi using SSH Client and Team Viewer </li>
                                <li>Understand Sensing actions </li>
                                <li>Understand Actuators and MEMS </li>
                                <li>Hands On/Demo</li>
                                <li>Programming Sense HAT Board </li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>IoT architecture </h6>
                            <ul>
                                <li>Architecture </li>
                                <li>Tech Stack </li>
                                <li>Protocols</li>
                        ...
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/iot.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>Basic programming skills is recommended but not mandatory </li>
                                <li>Electronics awareness is recommended but not mandatory </li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>This course is an intermediate course, professionals with minimum background in programming and basic understanding of electionics, will be ideal. Candidates without knowledge can also opt for this course </li>
                            <li>Students with a background of BE / B.Tech in ECE / CSE / ISE / Electrical & Electronics / Biomedical / Instrumentation / Msc Electronics and any other relevant streams </li>
                            <li>IOT Training is suitable for engineering students who are from electronics, computers or mechanical domain can find an opportunity in IOT Embedded Systems Development Industries. There is a growing demand for IOT developers / Software Engineers, Data Scientists and Product Managers in the Industry</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h3>Certification</h3>
                    <p>Certified IoT Professional </p>
                </div>
            </div>
        </div>
    </section>
