            ...
            <div class="col-sm-8">
                <div class="course-details">
                    ...
                    <div class="ratings">
                        ...
                        <p>4715 Ratings (4.3)</p>
                    </div>
                    <p class="para">This course will introduce the audience to SharePoint Online Administration in Office 365 and explain and demonstrate the configuration options for SharePoint Online. The course is appropriate for existing SharePoint on-premises administrators and new administrators to Office 365 who need to understand how to correctly setup SharePoint Online for their company. The course will also help SharePoint on-premise administrators understand the differences between SharePoint on-premises and SharePoint Online.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/microsoft-sharepoint-administrator.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/microsoft-sharepoint-administrator.jpg" alt="microsoft-sharepoint-administrator">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>This course will introduce the audience to SharePoint Online Administration in Office 365 and explain and demonstrate the configuration options for SharePoint Online. The course is appropriate for existing SharePoint on-premises administrators and new administrators to Office 365 who need to understand how to correctly setup SharePoint Online for their company. The course will also help SharePoint on-premise administrators understand the differences between SharePoint on-premises and SharePoint Online.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Introducing SharePoint 2019 </h6>
                            <ul>
                                <li>What is SharePoint Server 2019 </li>
                                <li>SharePoint Version History </li>
                                <li>MOSS Vs. SharePoint Server 2019 </li>
                                <li>Addressing Collaboration </li>
                                <li>Planning and Installing SharePoint Server 2019 </li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>SharePoint Management Model </h6>
                            <ul>
                                <li>Planning Farm Topology </li>
                                <li>Information Architecture Changes </li>
                                <li>Logical Architecture Changes </li>
                                <li>Physical Topology Changes </li>
                                <li>Installation Models </li>
                                <li>System & Software Requirements </li>
                                <li>Performing a Clean Installation </li>
                                <li>Running Configuration Wizard </li>
                                <li>Administration SharePoint 2019 </li>
                            </ul>
                            <h6>SharePoint Terminology </h6>
                            <ul>
                                <li>Post Installation Tasks </li>
                                <li>Central Administration </li>
                                <li>Manage Service Application and SharePoint 80 Web Apps </li>
                                <li>Creating Site Collection, Sub sites ,Removing Sites </li>
                                <li>Personalization Settings </li>
                                <li>Site Directory </li>
                                <li>Audience Targeting </li>
                                <li>User Profiles </li>
                                <li>Managing SharePoint Server 2019 Security </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/microsoft-sharepoint-administrator.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>This course is designed for administrators who need to setup, configure and manage SharePoint Online. Attendees need to have a basic understanding of Office 365 and a basic understanding of using PowerShell</li>
                                <li>Having experience on .Net framework will be helpful in making your learning of course even more successful</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>This course is designed for Administrators who need to setup, configure and manage SharePoint Online as part of their Office 365 Administration</li>
                        </ul>
                    </div>
                </div>
            </div>
