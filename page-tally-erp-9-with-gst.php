                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>Tally is one such course in Accounting which can help you climb your career ladder at a faster pace. We tried explaining complete information that can be useful for you related to Tally Course. Find details such as Tally Course Duration, Eligibility & Requirements, Colleges that offer Tally Course, Salary, etc. Have an idea what is Tally all about and why it is important by referring further. </p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Basics of Accounting </h6>
                            <ul>
                                <li>Introduction</li>
                                <li>Accounting Principles, Concepts and Convention </li>
                                <li>Double Entry System of Book Keeping </li>
                                <li>Types of Accounts </li>
                                <li>Golden Rules of Accounting </li>
                                <li>Mode of Accounting </li>
                                <li>Financial Statements </li>
                                <li>Recording Transactions of Sample Data </li>
                            </ul>
                            <h6>Fundamentals of Tally.ERP 9 </h6>
                            <ul>
                                <li>Introduction </li>
                                <li>Getting Functional with Tally.ERP 9 </li>
                                <li>Creation / Setting up of Company in Tally.ERP 9 </li>
                                <li>Company Features </li>
                                <li>Configurations </li>
                            </ul>
                            <h6>Creating Accounting Masters in Tally.ERP 9 </h6>
                            <ul>
                                <li>Chart of Accounts </li>
                                <li>Groups </li>
                                <li>Ledgers </li>
                                <li>Walkthrough for creating Chart of Accounts </li>
                                <li>Practice Exercises </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/tally-erp-9-with-gst.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>Need Computer Basics </li>
                                <li>Be able to Listen </li>
                                <li>Be able to Watch </li>
                                <li>Interested on Accounts, Tally, GST, Taxes </li>
                                <li>with/without Commerce Background </li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>From Commerce Stream </li>
                            <li>Candidate must complete 10+2 equivalent with required aggregate from a recognized college</li>
                            <li>Should have basic knowledge of Business Management</li>
                        </ul>
                    </div>
                </div>
            </div>
