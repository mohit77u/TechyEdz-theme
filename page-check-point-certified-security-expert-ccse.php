        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>Check Point Certified Security Expert (CCSE)</h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>3290 Ratings (4.2)</p>
                    </div>
                    <p class="para">In this course teaches how to build, modify, deploy and troubleshoot Check Point Security Systems on the GAiA operating system. Hands-on lab exercises teach how to debug firewall processes, optimize VPN performance and upgrade Management Servers. Check Point Certified Security Expert training will validate your understanding and skills necessary to configure and optimally manage Check Point Next Generation Firewalls. Hands-on lab exercises teach how to debug firewall processes, optimize VPN performance and upgrade Management Servers.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/check-point-certified-security-expert-ccse.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/check-point-certified-security-expert-ccse.jpg" alt="check-point-certified-security-expert-ccse">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>In this course teaches how to build, modify, deploy and troubleshoot Check Point Security Systems on the GAiA operating system. Hands-on lab exercises teach how to debug firewall processes, optimize VPN performance and upgrade Management Servers. Check Point Certified Security Expert training will validate your understanding and skills necessary to configure and optimally manage Check Point Next Generation Firewalls. Hands-on lab exercises teach how to debug firewall processes, optimize VPN performance and upgrade Management Servers.</p>
                            <h3>What you will Learn: </h3>
                            <ul>
                                <li>Backup your Security Gateway and Management Server</li>
                                <li>Build, test and troubleshoot a clustered Security Gateway</li>
                                <li>Upgrade and troubleshoot a Management Server</li>
                                <li>Configure and maintain security acceleration solutions</li>
                                <li>Manage, test and optimize corporate VPN tunnels</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Check Point Firewall Infrastructure</h6>
                            <ul>
                                <li>GUI Clients</li>
                                <li>Management</li>
                            </ul>
                        ...
                        <div class="topic-content">
                            <h6>Security Gateway User and Kernel Mode Processes</h6>
                            <ul>
                                <li>CPC Core Process</li>
                                <li>FWM</li>
                                <li>FWD</li>
                                <li>CPWD</li>
                                <li>Inbound and Outbound Packet Flow</li>
                                <li>Inbound FW CTL Chain Modules</li>
                                <li>Outbound Chain Modules</li>
                                <li>Columns in a Chain</li>
                        ...
                        <div class="topic-content">
                            <h6>Kernel Tables</h6>
                            <ul>
                                <li>Connections Table</li>
                                <li>Connections Table Format</li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/check-point-certified-security-expert-ccse.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>Security Administration Course or CCSA certification (R80 Not R77)</li>
                                <li>Windows Server, UNIX and networking skills and TCP/IP experience</li>
                                <li>Certificate management and system administration</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>Expert users and resellers who need to perform advanced deployment configurations of Check Point Software Blades</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h3>Certification</h3>
                    <p>Check Point Certified Security Expert (CCSE) R80.x</p>
                </div>
            </div>
        </div>
    </section>
