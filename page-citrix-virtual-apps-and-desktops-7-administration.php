        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>Citrix Virtual Apps and Desktops 7 Administration</h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>3890 Ratings (4.4)</p>
                    </div>
                    <p class="para">This course will teach you how to deploy, install, configure, setup profile management, configure policies, printing and basic security features for on-premises Virtual Apps and Desktop solution building, and then migrating to Citrix Cloud.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/citrix-virtual-apps-and-desktops-7-administration.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/citrix-virtual-apps-and-desktops-7-administration.jpg" alt="citrix-virtual-apps-and-desktops-7-administration">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>This course will teach you how to deploy, install, configure, setup profile management, configure policies, printing and basic security features for on-premises Virtual Apps and Desktop solution building, and then migrating to Citrix Cloud.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            ...
                            <ul>
                                <li>Introduction to Citrix Virtual Apps and Desktops</li>
                                <li>Architecture Overview </li>
                                <li>Features </li>
                                <li>Hosting Platform Considerations </li>
                                <li>Citrix Virtual Apps and Desktops Service </li>
                                <li>Connection Flow Process Introduction </li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Deploy the Site</h6>
                            <ul>
                                <li>Pre-Deployment Considerations </li>
                                <li>Citrix Licensing Setup </li>
                                <li>Delivery Controller Setup </li>
                                <li>Site Setup And Management </li>
                                <li>Redundancy Considerations </li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>The Apps and Desktops Images</h6>
                            <ul>
                                <li>Consider Master Image Creation Methods</li>
                                <li>Master Image Requirements</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Provision and Deliver App and Desktop Resources </h6>
                            <ul>
                                <li>Machine Catalogs and Delivery Groups</li>
                                <li>Provisioning Methods and Considerations </li>
                                <li>Machine Creation Services (MCS) Deep Dive </li>
                                <li>MCS Environment Considerations </li>
                                <li>Resource Locations </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/citrix-netscaler.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>This course requires basic knowledge of AD, Windows, Storage, Networking and little to no previous experience with the Citrix Virtual Apps and Desktops 7 version</li>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>IT Professionals who want to be familiar with Citrix Virtual Apps and Desktops 7 in an on-premises environment and Citrix Cloud</li>
                            <li>Potential students include administrators or engineers responsible for the end user workspace and overall health and performance of the solution</li>
                        </ul>
                    </div>
                </div>
            </div>
