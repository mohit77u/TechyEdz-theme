        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>Automating Windows Administration using Powershell </h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>4395 Ratings (4.5)</p>
                    </div>
                    <p class="para">Windows PowerShell is object-oriented automation engine and scripting language. It is designed mainly for the system administrators. It helps IT, professionals, to control & automate the administration of the Window OS and other applications.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/powershell-scripting.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/powershell-scripting.png" alt="powershell-scripting">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>Windows PowerShell is object-oriented automation engine and scripting language. It is designed mainly for the system administrators. It helps IT, professionals, to control & automate the administration of the Window OS and other applications.</p>
                            <p>It introduced some compelling new concepts that enable you to extend the knowledge you have gained and the scripts that you have created within the Windows Command Prompt and Windows Script Host environments.</p>
                            <p>It combines the flexibility of scripting, command-line speed, and the power of a GUI-based admin tool. It allows you to solve problems efficiently by helping system admin to eliminate future manual labor hours. We will go through all the important aspect which you should know to learn PowerShell.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Introduction</h6>
                            <ul>
                                <li>Getting to know about Windows PowerShell </li>
                                <li>Command Line Interface, Capabilities of PowerShell </li>
                                <li>Basic commands and Command design structure </li>
                                <li>Understanding the get-help in PowerShell </li>
                                <li>Understanding the basic Syntax for PowerShell</li>
                            </ul>
                            <h6>Getting started with Technical commands</h6>
                            <ul>
                                <li>Understanding the Headers </li>
                                <li>Working with Pipeline Operator, Where-object and Syntax </li>
                                <li>Working with Operators: Arithmetic Operators, Comparison Operators & Logical Operators </li>
                            </ul>
                            <h6>Working with Multiple Operators </h6>
                            <ul>
                                <li>Designing a single liner Powershell command </li>
                                <li>Formatting Options: Format-Table vs Select Object vs Format-list </li>
                                <li>Sort-object & Common Parameters </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/powershell-scripting.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>Working knowledge of Windows Server and Windows Client management </li>
                                <li>Prior experience in installing and configuring Windows </li>
                                <li>Working knowledge of network adapter configuration </li>
                                <li>Foundational understanding of Active Directory user administration and disk configuration </li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>The course is best suited for IT professionals, who have general Windows Server and Windows Client administration experience</li>
                            <li>It is especially going to be useful for all those professionals who are required to install and use this operating system to perform various duties in their respective organizations</li>
                        </ul>
                    </div>
                </div>
            </div>
