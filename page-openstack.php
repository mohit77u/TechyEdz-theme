        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>OpenStack Certification Training </h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>4165 Ratings (4.9)</p>
                    </div>
                    <p class="para">Red Hat OpenStack Administration I: Core Operations for Domain Operators (CL110) teaches you how to operate and manage a production Red Hat OpenStack Platform (RHOSP) single-site overcloud. You will learn how to create secure project environments in which to provision resources and manage security privileges that cloud users need to deploy scalable cloud applications. You will learn about OpenShift integration with load balancers, identity management, monitoring, proxies, and storage. You will also develop more troubleshooting and Day 2 operations skills in this course.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/openstack.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/openstack.png" alt="openstack">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <h5>Learning Path</h5>
                            <ul>
                                <li>Red Hat OpenStack Technical Overview (CL010) – Beginner </li>
                                <li>Red Hat OpenStack Administration I: Core Operations for Cloud Operators (CL110) – Intermediate</li>
                                <li>Red Hat OpenStack Administration II: Infrastructure Configuration for Cloud Administrators (CL210) - Intermediate</li>
                                <li>Red Hat OpenStack Administration III: Networking & Foundations of NFV (CL310) - Advanced</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h5>Red Hat OpenStack Technical Overview (CL010) </h5>
                            <h6>Through this course you will learn about</h6>
                            <ul>
                                <li>Cloud computing </li>
                                <li>Red Hat OpenStack Platform </li>
                                <li>Compute, storage, and network in relation to Red Hat OpenStack Platform </li>
                                <li>High availability with Red Hat OpenStack Platform </li>
                                <li>Deploying Red Hat OpenStack Platform</li>
                            </ul>
                            <h6>Course Outline: </h6>
                            <ul>
                                <li>Red Hat OpenStack Platform technical overview </li>
                                <li>Defining the cloud (with demonstration) </li>
                                <li>Defining the Red Hat OpenStack Platform </li>
                                <li>Use case: Infrastructure-as-a-Service (IaaS) and a private cloud </li>
                                <li>Compute in Red Hat OpenStack Platform (with demonstration) </li>
                                <li>Storage in Red Hat OpenStack Platform </li>
                                <li>Use case: Object storage with streaming video </li>
                                <li>Network in Red Hat OpenStack Platform </li>
                                <li>Use case: Networking for a telecommunication organization </li>
                                <li>Highly available Red Hat OpenStack Platform </li>
                                <li>Deploying Red Hat OpenStack Platform </li>
                            </ul>
                        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>IT leaders, administrators, engineers, architects, and anyone else seeking a highlevel understanding of Red Hat OpenStack Platform capabilities </li>
                        </ul>
                    </div>
                </div>
            </div>
