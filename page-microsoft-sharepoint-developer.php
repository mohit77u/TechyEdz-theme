        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>Microsoft SharePoint Developer </h2>
                    <div class="ratings">
                        <div class="star">
                    ...
                    <p class="para">This course is intended for professional developers who use Microsoft SharePoint 2013 in a team-based, medium- to large-sized development environment. SharePoint 2013 Developer provides existing .NET developers with practical information and labs that enables them to build solutions on the Microsoft SharePoint 2013 platform. SharePoint is a web based collaborative platform that integrates with Microsoft Office. Launched in2001, SharePoint is primarily sold as a document management and storage system, but the product is highly configurable and usage varies substantially between organizations. This training will sharpen your skills in optimizing SharePoint applications, exploring workflows in SharePoint Designer, creating Office app, deploying it to catalogue, and installing them.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/microsoft-sharepoint-developer.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/microsoft-sharepoint-developer.png" alt="microsoft-sharepoint-developer">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>This course is intended for professional developers who use Microsoft SharePoint 2013 in a team-based, medium- to large-sized development environment. SharePoint 2013 Developer provides existing .NET developers with practical information and labs that enables them to build solutions on the Microsoft SharePoint 2013 platform. SharePoint is a web based collaborative platform that integrates with Microsoft Office. Launched in2001, SharePoint is primarily sold as a document management and storage system, but the product is highly configurable and usage varies substantially between organizations. This training will sharpen your skills in optimizing SharePoint applications, exploring workflows in SharePoint Designer, creating Office app, deploying it to catalogue, and installing them.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Introduction to the SharePoint 2013 Development Platform </h6>
                            <ul>
                                <li>SharePoint 2013 as a Development Platform </li>
                                <li>SharePoint 2013 Object Hierarchy </li>
                                <li>Working with SharePoint 2013 Objects </li>
                                <li>Lab: Creating SharePoint 2013 Application Pages by Using Visual Studio 2013 </li>
                                <li>Lab: Enumerating SharePoint 2013 Farm Hierarchies </li>
                                <li>Lab: Manipulating Properties of Objects in the SharePoint Farm </li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Using SharePoint 2013 Developer Tools </h6>
                            <ul>
                                <li>Developing SharePoint Sites by Using SharePoint Designer 2013 </li>
                                <li>Developing SharePoint Solutions by Using Visual Studio 2013 </li>
                                <li>Packaging and Deploying SharePoint 2013 Solutions </li>
                                <li>Lab: Creating Document Libraries by Using SharePoint Designer 2013 </li>
                                <li>Lab: Creating SharePoint List Definitions and Instances by Using Visual Studio 2013</li>
                                <li>Lab: Packaging Features and Solutions by Using Visual Studio 2013 </li>
                            </ul>
                            <h6>Developing SharePoint 2013 Web Parts </h6>
                            <ul>
                                <li>Developing Standard Web Parts </li>
                                <li>Developing Connected Web Parts </li>
                                <li>Developing Visual Web Parts </li>
                                <li>Lab: Creating, Deploying, and Debugging a Simple Web Part by Using Visual Studio 2013 </li>
                                <li>Lab: Using SharePoint Components in a Web Part </li>
                                <li>Lab: Creating a Visual Web Part by Using Visual Studio 2013 </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/microsoft-sharepoint-developer.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>Familiarity with SharePoint environments </li>
                                <li>Familiarity with SharePoint capabilities and online services such as Azure, and SharePoint Online </li>
                                <li>Knowledge of or experience in developing Office client apps</li>
                                <li>Before attending this course, students should ideally be Developers with 1-2 years ASP.NET development experience</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            ...
                            <li>Attendees should have professional development experience with Visual Studio, the NET framework and ASP. NET (C#.Net / VB.NET – Any Version)</li>
                        </ul>
                    </div>
                </div>
            </div>
