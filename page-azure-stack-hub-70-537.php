            ...
            <div class="col-sm-8">
                <div class="course-details">
                    ...
                    <div class="ratings">
                        ...
                        <p>2615 Ratings (4.2)</p>
                    </div>
                    <p class="para">This course provides you with the knowledge required to deploy and configure Microsoft Azure Stack. You will discuss the differences between Microsoft Azure Stack, Microsoft Azure, and Windows Azure Pack. You will then review Software Defined Networking and configuring resource providers within Microsoft Azure Stack as well as establishing best practices for monitoring and troubleshooting.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/azure-stack-hub-70-537.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/azure-all.jpg" alt="azure-stack-hub-70-537">
            </div>
        </div>
    </div>
</section>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Build test environments by using the Azure Stack Hub Development Kit (ASDK)</h6>
                            <p>This objective may include but is not limited to: use PowerShell commands; install updated ASDK; troubleshoot failed installs; postdeployment registration.</p>
                        </div>
                        <div class="topic-content">
                            <h6>Configure identity and PKI for data center integration</h6>
                            <p>This objective may include but is not limited to: integrate Azure Stack Hub with AD FS, create custom RBAC roles for Azure Stack registration, validate Azure identity, validate AD FS integaration, validate graph integration, generate PKI certificates, validate PKI certificates, remediate PKI certificates.</p>
                        </div>
                        <div class="topic-content">
                            <h6>Configure DNS for data center integration</h6>
                            <p>This objective may include but is not limited to: configure external DNS name resolution from within Azure Stack Hub; configure Azure Stack Hub DNS names from outside Azure Stack Hub.</p>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/azure-stack-hub-70-537.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            ...
                            <ul>
                                <li>Working knowledge of Windows Server 2016</li>
                                <li>Working knowledge of SQL Server 2014</li>
                                <li>Working knowledge of Microsoft Azure </li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <p>This course is intended for service administrators, DevOps, and cloud architects who are interested in using Microsoft Azure Stack to provide cloud services to their end users or customers from within their own datacenter.</p>
                    </div>
                </div>
            </div>
        </div>
