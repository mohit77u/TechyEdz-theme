        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>Azure AI Solution (AZ AI - 100)</h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>3125 Ratings (4.6)</p>
                    </div>
                    <p class="para">This learning path is designed to help you prepare for the AI-100 Designing and Implementing an Azure AI Solution exam. Even if you don't plan to take the exam, these courses and hands-on labs will help you get started on your way to becoming an Azure AI engineer. This exam is part of Microsoft’s role-based certification program. Candidates who pass the AI-100 exam will earn the Microsoft Certified: Azure AI Engineer Associate certification.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/azure-ai-solution-az-ai-100.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/azure-ai-solution-az-ai-100.jpg" alt="azure-ai-solution-az-ai-100">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>This learning path is designed to help you prepare for the AI-100 Designing and Implementing an Azure AI Solution exam. Even if you don't plan to take the exam, these courses and hands-on labs will help you get started on your way to becoming an Azure AI engineer.</p>
                            <p>This exam is part of Microsoft’s role-based certification program. Candidates who pass the AI-100 exam will earn the Microsoft Certified: Azure AI Engineer Associate certification.</p>
                            <p>The AI-100 exam tests your knowledge of three subject areas: analyzing solution requirements, designing AI solutions, and implementing and monitoring AI solutions. This learning path starts by giving you an overview of Azure services. Once you have that foundation, we’ll dig into how to use the various Cognitive Services. They’re divided into five categories: decision, language, speech, vision, and web search. Next, we’ll show you how to build a chatbot using the Azure Bot Service. Finally, we’ll show you how to tie all of the components together into pipelines and data flows using services like Azure Data Factory.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Recommend Azure Cognitive Services APIs to meet business requirements</h6>
                            <ul>
                                <li>select the processing architecture for a solution</li>
                                <li>select the appropriate data processing technologies</li>
                                <li>select the appropriate AI models and services</li>
                                <li>identify components and technologies required to connect service endpoints</li>
                                <li>identify automation requirements</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Map security requirements to tools, technologies, and processes</h6>
                            <ul>
                                <li>identify processes and regulations needed to conform with data privacy, protection, and regulatory requirements</li>
                                <li>identify which users and groups have access to information and interfaces</li>
                                <li>identify appropriate tools for a solution</li>
                                <li>identify auditing requirements</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Select the software, services, and storage required to support a solution</h6>
                            <ul>
                                <li>identify appropriate services and tools for a solution</li>
                                <li>identify integration points with other Microsoft services</li>
                                <li>identify storage required to store logging, bot state data, and Azure Cognitive Services output</li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/azure-ai-solution-az-ai-100.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="about">
                        ...
                        <div class="topic-content">
                            ...
                            <ul>
                                ...
                                <li>Software development experience, especially using REST APIs</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            ...
                            <li>Software developers who want to build artificial intelligence solutions on Azure</li>
                        </ul>
                    </div>
                </div>
            </div>
