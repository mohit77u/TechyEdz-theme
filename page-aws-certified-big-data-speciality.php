        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>AWS Certified Big Data Speciality</h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>1950 Ratings (4.6)</p>
                    </div>
                    <p class="para">The AWS Certified Big Data - Specialty (DAS-C01) examination is intended for individuals who perform in a data analytics-focused role. This exam validates an examinee’s comprehensive understanding of using AWS services to design, build, secure, and maintain analytics solutions that provide insight from data. In this certification course is geared for people who want to enhance their skills in AWS to help organizations design and migrate their architecture to the cloud.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/aws-certified-big-data-speciality.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>The AWS Certified Big Data - Specialty (DAS-C01) examination is intended for individuals who perform in a data analytics-focused role. This exam validates an examinee’s comprehensive understanding of using AWS services to design, build, secure, and maintain analytics solutions that provide insight from data. In this certification course is geared for people who want to enhance their skills in AWS to help organizations design and migrate their architecture to the cloud.</p>
                            <p> This is the next step after obtaining your Cloud Practitioners Certification. This course will develop your skills your learned from the Cloud Practitioners Course in further detail. We cover a broad range of topics with a specific concentration on High Availability, EC2, VPC, Storage and Overall Management of the AWS Console.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Collection</h6>
                            <ul>
                                <li>Determine the operational characteristics of the collection system</li>
                                <li>Select a collection system that handles the frequency, volume, and source of data</li>
                                <li>Select a collection system that addresses the key properties of data, such as order, format, and compression</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Storage and Data Management</h6>
                            <ul>
                                <li>Determine the operational characteristics of a storage solution for analytics</li>
                                <li>Determine data access and retrieval patterns</li>
                                <li>Select an appropriate data layout, schema, structure, and format</li>
                                <li>Define a data lifecycle based on usage patterns and business requirements</li>
                                <li>Determine an appropriate system for cataloging data and managing metadata</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Processing</h6>
                            <ul>
                                <li>Determine appropriate data processing solution requirements</li>
                                <li>Design a solution for transforming and preparing data for analysis</li>
                                <li>Automate and operationalize a data processing solution</li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/aws-certified-big-data-speciality.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>A minimum of 5 years of experience with common data analytics technologies</li>
                                <li>At least 2 years of hands-on experience working on AWS</li>
                                <li>Experience and expertise working with AWS services to design, build, secure, and maintain analytics solutions</li>
                                <li>Beginner Data science students and data analysts</li>
                                <li>Anyone working with big data</li>
                                <li>Beginners who want to full career in data analytics with machine learning within AWS ecosystem</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>Students should have sufficient AWS knowledge and have 2 years or more experience with AWS</li>
                            <li>Beginners can also learn from scratch but will have to go through extensive lectures</li>
                            <li>Existing AWS power users</li>
                            <li>AWS services are not free so you may incur charges from AWS and you are responsible</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h3>Certification</h3>
                    <p>AWS Certified Data Analytics – Specialty (DAS-C01)</p>
                </div>
            </div>
        </div>
    </section>
