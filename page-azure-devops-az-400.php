        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>Azure Designing and Implementing Microsoft DevOps Solutions (AZ-400)</h2>
                    <div class="ratings">
                        <div class="star">
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>This course measures your ability to accomplish the following technical tasks: develop an instrumentation strategy; develop a Site Reliability Engineering (SRE) strategy; develop a security and compliance plan; manage source control; facilitate communication and collaboration; define and implement continuous integration; and define and implement a continuous delivery and release management strategy.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Design and implement logging</h6>
                            <ul>
                                <li>assess and Configure a log framework</li>
                                <li>design a log aggregation and storage strategy (e.g. Azure storage)</li>
                                <li>design a log aggregation using Azure Monitor</li>
                                <li>manage access control to logs (workspace-centric/resource-centric)</li>
                                <li>integrate crash analytics (App Center Crashes, Crashlytics)</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Design and implement telemetry</h6>
                            <ul>
                                <li>design and implement distributed tracing</li>
                                <li>inspect application performance indicators</li>
                                <li>inspect infrastructure performance indicators</li>
                                <li>define and measure key metrics (CPU, memory, disk, network)</li>
                                <li>implement alerts on key metrics (email, SMS, webhooks, Teams/Slack)</li>
                                <li>integrate user analytics (e.g. Application Insights funnels, Visual Studio App Center, TestFlight, Google Analytics)</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Integrate logging and monitoring solutions</h6>
                            <ul>
                                <li>configure and integrate container monitoring (Azure Monitor, Prometheus, etc.)</li>
                                <li>configure and integrate with monitoring tools (Azure Monitor Application Insights, Dynatrace, New Relic, Naggios, Zabbix)</li>
                                <li>create feedback loop from platform monitoring tools (e.g. Azure Diagnostics VM extensions, Azure Platform Logs, Event Grid)</li>
                                <li>manage Access control to the monitoring platform</li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/azure-devops-az-400.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>Fundamental knowledge about Azure, version control, Agile software development, and core software development principles. It would be helpful to have experience in an organization that delivers software</li>
                                <li>To become a Microsoft Certified: Azure DevOps Engineer Expert, you must either earn the Azure Administrator Associate or Azure Developer Associate certification</li>
                                <li>Great pre-requisite courses for those certifications are Microsoft Azure Administrator (AZ-104) or Developing Solutions for Microsoft Azure (AZ-204)</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>Candidates for this exam should have subject matter expertise working with people, processes, and technologies to continuously deliver business value.</li>
                            <li>Responsibilities for this role include designing and implementing strategies for collaboration, code, infrastructure, source control, security, compliance, continuous integration, testing, delivery, monitoring, and feedback.</li>
                            <li>A candidate for this exam must be familiar with both Azure administration and development and must be expert in at least one of these areas.</li>
                        </ul>
                    </div>
                </div>
            </div>
