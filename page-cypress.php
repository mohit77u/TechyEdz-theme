        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>Automation Testing with Cypress</h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>4270 Ratings (4.3)</p>
                    </div>
                    <p class="para">Cypress training courses demonstrate through interactive hands-on practice how to set up, write, run, and debug tests for any frontend application or website with Cypress. This Training is aimed at software testers who wish to use Cypress for automating tests.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/cypress.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/cypress.jpg" alt="cypress">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>Cypress training courses demonstrate through interactive hands-on practice how to set up, write, run, and debug tests for any frontend application or website with Cypress. This Training is aimed at software testers who wish to use Cypress for automating tests.</p>
                            <p>By the end of this training, participants will be able to: </p>
                            <ul>
                                <li>Perform end-to-end automation testing with Cypress</li>
                                <li>Implement integration and unit tests in a web application</li>
                                <li>Use Cypress as an alternative to Selenium</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            ...
                            <ul>
                                <li>What is Cypress.io </li>
                                <li>Editors </li>
                                <li>Install and Setup Cypress </li>
                                <li>Prettier Setup </li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Cypress Basics </h6>
                            <ul>
                                <li>Cypress Structure walkthrough </li>
                                <li>First Cypress Test </li>
                                <li>Running Tests in Headless Mode </li>
                                <li>Load URL </li>
                                <li>Assertions</li>
                                <li>Implicit Waits, Pause, Debug </li>
                                <li>Interacting with Buttons </li>
                                <li>Cypress Logs </li>
                                <li>Clear & Type text into Inputs </li>
                                <li>Interacting with Checkbox </li>
                                <li>Variables and Aliases </li>
                                <li>Chaining Assertions </li>
                                <li>Clear Cookies & Local Storage </li>
                                <li>Time & Date Modification </li>
                                <li>Viewport & Devices Emulation </li>
                                <li>Get & Assert page titles </li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Advanced Cypress Automation </h6>
                            <ul>
                                <li>Explore Cypress JSON file </li>
                                <li>Fixtures & Static Test Data</li>
                                <li>Keyboard Press Simulation </li>
                                <li>Run All Specs Together </li>
                                <li>Custom Commands </li>
                                <li>Working with Select Box </li>
                                <li>Screenshots </li>
                                <li>Scrolling on the Page </li>
                                <li>Read/Write Data into JSON / Local Data Files </li>
                                <li>Assert Content Type </li>
                                <li>Before & After Hooks </li>
                                <li>Only & Skip Hooks </li>
                                <li>Cypress.$ Function </li>
                                <li>Command Line - Run single test file in headless mode </li>
                            </ul>
                        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>Basic Javascript knowledge or any other programming language </li>
                            </ul>
                        </div>
                    </div>
                </div>
