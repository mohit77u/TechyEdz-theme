        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>VMware vCenter Site Recovery Manager </h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>4395 Ratings (4.3)</p>
                    </div>
                    <p class="para">This two-day, hands-on training course equips experienced VMware vSphere administrators with the knowledge to install, configure, and manage VMware vCenter Site Recovery Manager. This course also equips vSphere administrators with the knowledge to assist in writing and testing disaster recovery plans that use vCenter Site Recovery Manager.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/vmware-vcenter-site-recovery-manager.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/vmware-vcenter-site-recovery-manager.jpg" alt="vmware-vcenter-site-recovery-manager">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>This two-day, hands-on training course equips experienced VMware vSphere administrators with the knowledge to install, configure, and manage VMware vCenter Site Recovery Manager. This course also equips vSphere administrators with the knowledge to assist in writing and testing disaster recovery plans that use vCenter Site Recovery Manager.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Introductions and course logistics </h6>
                            <ul>
                                <li>Course goals and objectives </li>
                                <li>About vCenter Site Recovery Manager </li>
                                <li>VMware online resources </li>
                                <li>vCenter Site Recovery Manager product documentation </li>
                            </ul>
                            <h6>Overview and Architecture </h6>
                            <ul>
                                <li>Describe how venter Site Recovery Manager is used for disaster recovery </li>
                                <li>Use the VMware vSphere® Web Client as the interface for vCenter Site Recovery Manager </li>
                                <li>Discuss vCenter Site Recovery Manager features </li>
                                <li>Compare different vCenter Site Recovery Manager Architecture topologies </li>
                            </ul>
                            <h6>Installing VMware vCenter Site Recovery Manager </h6>
                            <ul>
                                <li>Identify version requirements for the vSphere and vCenter elements that operate with vCenter Site Recovery Manager </li>
                                <li>Describe requirements for installing vCenter Site Recovery Manager Server software </li>
                                <li>Discuss alternatives for the vCenter Site Recovery Manager database </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/vmware-vcenter-site-recovery-manager.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                ...
                                <li>Basic knowledge of disaster recovery concepts </li>
                                <li>Basic knowledge of storage array technology</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>vSphere administrators, architects, system engineers, and systems integrators who are responsible for the deployment or management of vCenter Site Recovery Manager </li>
                        </ul>
                    </div>
                </div>
            </div>
