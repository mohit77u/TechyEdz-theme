        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    ...
                    <p class="para">Node.js is an open source, cross-platform framework running on Mac OSX, Windows, and Linux. Node.js course has been designed to help developers understand and build web applications with the help of JavaScript. Node.js is an eventdriven, server-side JavaScript environment that runs JavaScript using the V8 engine developed by Google. The course focuses on various important concepts of Node.js and provides hands-on experience in building HTTP server with Node.js, working with file system, buffers, stream, events, and multi-processing in Node.js. The training covers Express.js, which is a powerful and flexible web application framework.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/node-js.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/node-js.jpg" alt="node-js">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>Node.js is an open source, cross-platform framework running on Mac OSX, Windows, and Linux. Node.js course has been designed to help developers understand and build web applications with the help of JavaScript. Node.js is an eventdriven, server-side JavaScript environment that runs JavaScript using the V8 engine developed by Google. The course focuses on various important concepts of Node.js and provides hands-on experience in building HTTP server with Node.js, working with file system, buffers, stream, events, and multi-processing in Node.js. The training covers Express.js, which is a powerful and flexible web application framework Our training curriculum is designed to boost you understanding of best practices for the design, development & management of mission-critical Node.js applications.</p>
                            <h4>What you'll learn </h4>
                            <ul>
                                <li>You will learn Node js from the ground up</li>
                                <li>Learn how node works inside out </li>
                                <li>Create servers to serve web application </li>
                                <li>Interact with Nosql databases such as mongo</li>
                                <li>How to work with uploads </li>
                                <li>How sockets work with socket IO </li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Introduction and Foundation </h6>
                            <ul>
                                <li>Introduction </li>
                                <li>The Node.js framework </li>
                                <li>Installing Node.js </li>
                                <li>Using Node.js to execute scripts </li>
                            </ul>
                            <h6>Node Projects </h6>
                            <ul>
                                <li>The Node Package Manager </li>
                                <li>Creating a project </li>
                                <li>The package.json configuration file </li>
                                <li>Global vs. Local package installation </li>
                            </ul>
                        ...
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/node-js.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>If you are acquainted with JavaScript then you would find Node Js simple to learn</li>
                                <li>Knowing a liitle bit of HTML, CSS and Javascript, everything else you will learn it as we go</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>Students who want to learn web development</li>
                            <li>From beginners in javascript to intermediate</li>
