            ...
            <div class="col-sm-8">
                <div class="course-details">
                    ...
                    <div class="ratings">
                        ...
                        <p>4585 Ratings (4.4)</p>
                    </div>
                    <p class="para">In this course in-depth insights about Informatica MDM Server and how to administer it. You will get to learn everything from Introduction and defining the data model, Introduction to Informatica MDM Hub, Define the Data model, Configuring stage and load process, Configure the Stage process, Configure the Load process, Configuring merge process and data access, Configure the Match & Merge process, Configure data access views, Batch processes and data management tools, Data Management Tools, User exits and log files, User Exit Procedures, Log files, Hierarchy Management and security access manager, Hierarchy Management, Security Access Manager (SAM), Informatica data director, IDD Configuration, and more.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/informatica-mdm.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/informatica-mdm.jpg" alt="informatica-mdm">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>In this course in-depth insights about Informatica MDM Server and how to administer it. You will get to learn everything from Introduction and defining the data model, Introduction to Informatica MDM Hub, Define the Data model, Configuring stage and load process, Configure the Stage process, Configure the Load process, Configuring merge process and data access, Configure the Match & Merge process, Configure data access views, Batch processes and data management tools, Data Management Tools, User exits and log files, User Exit Procedures, Log files, Hierarchy Management and security access manager, Hierarchy Management, Security Access Manager (SAM), Informatica data director, IDD Configuration, and more.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Introduction to MDM </h6>
                            <ul>
                                <li>What is MDM? </li>
                                <li>Google trend report on MDM </li>
                                <li>What is the scope of this MDM course? </li>
                                <li>Why do we need MDM? </li>
                                <li>Will MDM cut jobs?</li>
                                <li>Is MDM a Hype or is it Real? </li>
                                <li>Where does MDM stand (Compared to other competitors)? </li>
                                <li>Google trend report on Competitors and comparison </li>
                                <li>Naukri and Monster job openings </li>
                                <li>Salary report from Indeed & Payscale </li>
                                <li>A walkthrough on the course content</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>What is Informatica MDM </h6>
                            <ul>
                                <li>Short Blue Informatica MDM with a Real time Project </li>
                                <li>Navigation </li>
                                <li>What is the scope of Informatica MDM Training </li>
                                <li>Important options and Shortcuts in the tool </li>
                                <li>Types of Tools in Informatica MDM(Walkthrough) </li>
                                <li>What’s the Architecture, SOA, Client server or Cloud </li>
                                <li>Informatica MDM Cloud? </li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Installation of Informatica MDM </h6>
                            <ul>
                                <li>Supported Systems (Is Windows, Linux, Mac supported) </li>
                                <li>What is the Alternative if it’s not Supported(Virtualbox) </li>
                                <li>Supported Databases </li>
                                <li>Integration with other tools</li>
                                <li>Limitations </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/informatica-mdm.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>For starting with Informatica you should have a thorough working knowledge of SQL, especially functions, joins, sub-queries, etc. Knowledge of PL/SQL is also recommended, but not mandatory</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>PowerCenter or Data Quality Administrators </li>
                            <li>Database developers and Managers </li>
                            <li>BI/ETL/DW Professionals </li>
                            <li>Informatica PowerCenter Administrators </li>
                            <li>Data Integration developers </li>
                            <li>Contributors in the Enterprise Business Intelligence field </li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h3>Certification</h3>
                    <p>MDM Multidomain 10.1 Developer Specialist </p>
                </div>
            </div>
        </div>
    </section>
