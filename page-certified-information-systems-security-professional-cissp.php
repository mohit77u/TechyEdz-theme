            ...
            <div class="col-sm-8">
                <div class="course-details">
                    ...
                    <div class="ratings">
                        ...
                        <p>3185 Ratings (4.7)</p>
                    </div>
                    <p class="para">The CISSP Certification Training Course consists of overall 8 Domains which in turn gain knowledge in the Information Security Field along with a detailed knowledge of the current industry standards and best practices a Security Practitioner needs to implement in their respective organization to keep it in a secure way.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/certified-information-systems-security-professional-cissp.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/certified-information-systems-security-professional-cissp.jpg" alt="certified-information-systems-security-professional-cissp">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>The CISSP Certification Training Course consists of overall 8 Domains which in turn gain knowledge in the Information Security Field along with a detailed knowledge of the current industry standards and best practices a Security Practitioner needs to implement in their respective organization to keep it in a secure way.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            ...
                            <ul>
                                <li>A Brief Introduction about Confidentiality, Integrity, and Availability</li>
                                <li>How to Apply Security Governance Principles?</li>
                                <li>Compliance</li>
                                <li>Legal and Regulatory issues related to Cyber Security</li>
                                <li>Understanding the difference between Security Policy, Standards, Procedures, and Guidelines</li>
                                <li>Understand the concept about Business Continuity Planning</li>
                                <li>Understand and Apply Risk Management Concepts</li>
                                <li>Understand and Apply Threat Modeling</li>
                                <li>Acquisition Strategy and Practice</li>
                        ...
                        <div class="topic-content">
                            ...
                            <ul>
                                ...
                                <li>Least Privilege and Need to Know bases Models</li>
                                <li>Privacy Protection</li>
                                <li>Data Retention Techniques and Security Controls associated with it</li>
                                <li>Secure Handling of Data</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Security Architecture and Engineering</h6>
                            <ul>
                                <li>Security Design Principles</li>
                                <li>Understanding Security Models</li>
                                <li>How to Implement Controls and Countermeasures adhering to the Information Security Standards</li>
                                <li>Assess and Mitigate the Vulnerabilities of Security Architectures Designs, Webbased Systems, Mobile Systems, OT Systems</li>
                                <li>Understanding the Concepts and applying Cryptography</li>
                                <li>Implementation of Physical Security in various sites and data centers</li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/certified-information-systems-security-professional-cissp.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <p>To apply for the CISSP Certification Training , you need to: </p>
                            <ul>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <p>The CISSP course is recommended for the following profiles: </p>
                        <ul>
