        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>Cyber Security Training Program</h2>
                    <div class="ratings">
                        <div class="star">
                    ...
                    <div class="content">
                        ...
                        <div class="topic-content">
                            ...
                            <ul>
                                ...
                                <li>CompTIA Security+ Exam Topics</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Introduction to Security</h6>
                            <ul>
                                <li>Security 101</li>
                                <li>Think Like a Hacker</li>
                                <li>Threat Actor Types and Attributes</li>
                                <li>Review Key Topics</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Computer Systems Security Part I</h6>
                            <ul>
                                <li>Malicious Software Types</li>
                                <li>Delivery of Malware</li>
                                <li>Preventing and Troubleshooting Malware</li>
                                <li>Lesson Summary</li>
                                <li>Review Key Topics</li>
                                <li>Complete the Real-World Scenarios</li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/cyber-security-master-program.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>One or two years of experience in networking support and IT administration</li>
                                <li>Able to use Windows to create and manage files and use basic administrative features (Explorer, Control Panel and Management Consoles)</li>
                                <li>Know basic network terminology and functions (such as OSI Model, topology, Ethernet, TCP/IP, switches and routers)</li>
                                <li>Understand TCP/IP addressing, core protocols and troubleshooting tools</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>The CompTIA Security+ course is ideal for professionals who are working in the roles of system administrators, network administrators, security administrators, and IT auditors</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <p>CompTIA Security + 501: 50hrs</p>
                        <p>Certified Ethical Hacker (CEH): 50hrs</p>
                        <p>CISM: 30hrs</p>
                        <p>CISSP: 40hrs</p>
                        <p>CCSP: 40hrs</p>
                    </div>
