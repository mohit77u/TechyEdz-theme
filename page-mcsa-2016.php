        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>Microsoft Certified Solutions Associate (MCSA 2016) </h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>4685 Ratings (4.4)</p>
                    </div>
                    <p class="para">Candidates for this exam are involved with the installation, storage, and compute functionalities available in Windows Server 2016. Candidates perform general installation tasks, as well as creating and managing images for deployment.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/mcsa-2016.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/mcsa-2016.jpg" alt="mcsa-2016">
            </div>
        </div>
    </div>
</section>
                    ...
                    <div class="content">
                        ...
                        <div class="topic-content">
                            ...
                            <ul>
                                ...
                                <li>install and configure Windows Server Core; manage Windows Server Core </li>
                                <li>installations using Windows PowerShell, command line, and remote management capabilities </li>
                        ...
                        <div class="topic-content">
                            ...
                            <ul>
                                ...
                                <li>manage and maintain Windows Server Core, and VHDs using Windows PowerShell </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/mcsa-2016.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>Basic technical user skills with computer applications on some operating systems are expected</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>All students who start their Microsoft servers study</li>
                            <li>Help Desk who wants to improve to next level as a system admin</li>
                            <li>System admins and engineers who want to study server 2016 in details </li>
                            <li>All professional who want to be ready for their MCSA 2016 certificates</li>
                        </ul>
                    </div>
                </div>
            </div>
