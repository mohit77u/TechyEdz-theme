        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>AWS Advanced Networking Speciality 2</h2>
                    <div class="ratings">
                        <div class="star">
                    ...
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/aws-advanced-networking-speciality2.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/aws-advanced-networking-speciality2.jpg" alt="aws-advanced-networking-speciality2">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>This course will help you to learn the most recent technologies in AWS. This Online course will let you mastery in AWS advanced networking. Our expert trainers will handle this course with more practical sessions through real-time training throughout this course. At the end of this course, you will be able to acquire more proficiency in AWS networking by pursuing the certification through industry best training practices.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/aws-advanced-networking-speciality.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
