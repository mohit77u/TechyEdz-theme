        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    ...
                    <p class="para">IBM offers a comprehensive portfolio of SAN switches, storage, software, services and solutions to reliably bring information to people in a cost effective way. IBM provides flexible, scalable and open standards-based business-class and global enterprise-class storage networking solutions for the on demand world. This course provides an overview of storage network and data center networking technology. It reviews SAN concepts, Fibre Channel architecture, SAN topologies, IBM btype offerings, IBM offerings from Cisco, and SAN over Ethernet architectures, such as iSCSI and FCoE.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/ibm-san-fundamentals.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/ibm-san-fundamentals.jpg" alt="ibm-san-fundamentals">
            </div>
        </div>
    </div>
</section>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>IBM SAN ENVIRONMENT </h6>
                            <ul>
                                <li>Describe IBM SAN product offerings </li>
                                <li>Discuss basic aspects of SAN interaction with Power systems </li>
                                <li>Describe course lab environment </li>
                                <li>Use AIX commands to identify system resources </li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>IBM SAN DEVICE MANAGEMENT </h6>
                            <ul>
                                <li>Identify and describe the basics of designing a SAN </li>
                                <li>Describe how to configure virtual Fibre Channel adapters </li>
                                <li>Utilize VIO server commands to identify Fibre Channel resources</li>
                                <li>Differentiate between physical & virtual Fibre Channel resources </li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>SAN BOOT </h6>
                            <ul>
                                ...
                                <li>Identify resources required to complete a SAN boot </li>
                                <li>Configure a SAN attached hdisk as a boot device </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/ibm-san-fundamentals.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <p>The following course, or equivalent knowledge, is required prior to this course: </p>
                            <ul>
                                <li>Introduction to Storage - (SS01G) </li>
                                <li>Introduction to Storage - (SS01G) </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>This is a base course for individuals who are involved in the planning, installing, configuring, and upgrading of IBM systems</li>
                        </ul>
                    </div>
                </div>
            </div>
