        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>NetApp SAN Implementation (SANIW) </h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>4365 Ratings (4.6)</p>
                    </div>
                    <p class="para">In this course, you learn how to connect Windows, vsphere, and Linux hosts via Fibre Channel (FC) and iscsi protocols to NetApp SANs.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/netapp-san-implementation.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/netapp-san-implementation.jpg" alt="netapp-san-implementation">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>In this course, you learn how to connect Windows, vsphere, and Linux hosts via Fibre Channel (FC) and iscsi protocols to NetApp SANs.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>San Review </h6>
                            <ul>
                                <li>Describe the differences between network-attached storage (NAS) and storage area network (SAN) </li>
                                <li>List the methods to implement SAN solutions </li>
                                <li>Define initiator, target and LUN </li>
                                <li>Describe ports, worldwide names, and worldwide port names </li>
                                <li>List the steps to implement a SAN </li>
                            </ul>
                            <h6>Windows FC Connectivity </h6>
                            <ul>
                                <li>Describe multiple path implementation with Fiber Channel (FC) connectivity </li>
                                <li>Configure FC ports on Windows® and NetApp® FAS systems </li>
                                <li>Use commands and utilities to identify the worldwide node name (WWNN) and worldwide port name (WWPN) on Windows and NetApp systems </li>
                                <li>Use commands and utilities to examine FC switch activity </li>
                            </ul>
                            <h6>Windows iSCSI Connectivity </h6>
                            <ul>
                        ...
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/netapp-san-implementation.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <p>The below is required before attending this class: </p>
                            <ul>
                                <li>Data ONTAP 7-Mode Administration (D7ADM) </li>
                                <li>Accelerated NCDA Boot Camp Data ONTAP 7-Mode (ANCDABC87) </li>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>Professionals who implement SAN solutions that use NetApp storage systems </li>
                        </ul>
                    </div>
                </div>
            </div>
