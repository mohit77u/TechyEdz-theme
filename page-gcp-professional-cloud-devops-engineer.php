        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>GCP Professional Cloud DevOps Engineer </h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>4765 Ratings (4.8)</p>
                    </div>
                    <p class="para">A Professional Cloud DevOps Engineer is responsible for efficient development operations that can balance service reliability and delivery speed. They are skilled at using Google Cloud Platform to build software delivery pipelines, deploy and monitor services, and manage and learn from incidents.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/gcp-professional-cloud-devops-engineer.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/gcp-professional-cloud-devops-engineer.png" alt="gcp-professional-cloud-devops-engineer">
            </div>
        </div>
    </div>
</section>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h4>Applying site reliability engineering principles to a service </h4>
                            <h6>Balance change, velocity, and reliability of the service</h6>
                            <ul>
                                <li>Discover SLIs (availability, latency, etc.) </li>
                        ...
                        <div class="topic-content">
                            <h6>Manage service life cycle</h6>
                            <ul>
                                <li>Manage a service (e.g., introduce a new service, deploy it, maintain and retire it) </li>
                                <li>Plan for capacity (e.g., quotas and limits management) </li>
                            </ul>
                            <h6>Ensure healthy communication and collaboration for operations</h6>
                            <ul>
                        ...
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/gcp-professional-cloud-devops-engineer.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>Although it is a professional-level certification, there are no prerequisites for taking the Professional Cloud DevOps Engineer exam</li>
                                <li>It is, however, a comprehensive and technical exam that will require you to have experience and/or have done extensive studies on DevOps and Site Reliability Engineering (SRE) with GC</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>3+ years of industry experience including 1+ years managing solutions on GCP</li>
                            <li>As a DevOps engineer should be responsible for efficient development operations that can balance reliability and delivery speed</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h3>Certification</h3>
                    <p>GCP Professional Cloud DevOps Engineer (GCP CDE ) </p>
                </div>
            </div>
        </div>
    </section>
