        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>AWS Machine Learning Speciality</h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>2750 Ratings (4.2)</p>
                    </div>
                    <p class="para">The AWS Certified Machine Learning - Specialty (MLS-C01) examination is intended for individuals who perform a development or data science role. This exam validates an examinee’s ability to build, train, tune, and deploy machine learning (ML) models using the AWS Cloud.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/aws-machine-learning-speciality.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/aws-machine-learning-speciality.jpg" alt="aws-machine-learning-speciality">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>The AWS Certified Machine Learning - Specialty (MLS-C01) examination is intended for individuals who perform a development or data science role. This exam validates an examinee’s ability to build, train, tune, and deploy machine learning (ML) models using the AWS Cloud.</p>
                            <p>Since 2006, Amazon Web Services has been the world’s most comprehensive and broadly adopted cloud platform. AWS offers over 90 fully featured services for compute, storage, networking, database, analytics, application services, deployment, management, developer, mobile, Internet of Things (IoT), Artificial Intelligence, security, hybrid and enterprise applications, from 44 Availability Zones across 16 geographic regions. AWS services are trusted by millions of active customers around the world — including the fastest-growing startups, largest enterprises, and leading government agencies — to power their infrastructure, make them more agile, and lower costs. It also gives you the hands-on experience required to use machine learning and deep learning in a real-world environment.</p>
                            <p>This course starts off with coming to grips with Machine Learning (ML), Deep Learning (DL), and Artificial Intelligence (AI) terminology. After the theory comes the practice. You'll get hands-on with a number of ML frameworks and AWS services specific to the certification.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="content">
                        ...
                        <div class="topic-content">
                            ...
                            <ul>
                                ...
                                <li>Machine Learning Algorithms Explained</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                        ...
                        <div class="topic-content">
                            ...
                            <ul>
                                ...
                                <li>Missing and Unbalanced Data</li>
                                <li>Label and One Hot Encoding</li>
                                <li>Splitting and Randomization</li>
                                <li>RecordIO Format</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                        ...
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/aws-machine-learning-speciality.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <p>The successful candidate likely has 1–2 years of hands-on experience developing, architecting, or running ML/deep learning workloads on the AWS Cloud, along with:</p>
                            <ul>
                                <li>The ability to express the intuition behind basic ML algorithms</li>
                                <li>Experience performing basic hyperparameter optimization</li>
                                <li>Experience with ML and deep learning frameworks</li>
                                <li>The ability to follow model-training best practices</li>
                                <li>The ability to follow deployment and operational best practices</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>Individuals performing a development or data science role seeking certification in machine learning and AWS</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h3>Certification</h3>
                    <p>AWS Certified Machine Learning – Specialty (MLS-C01) </p>
                </div>
            </div>
        </div>
    </section>
