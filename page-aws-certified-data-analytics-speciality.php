        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>AWS Certified Data Analytics Speciality</h2>
                    <div class="ratings">
                        <div class="star">
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>The AWS Certified Data Analytics - Specialty (DAS-C01) examination is intended for individuals who perform in a data analytics-focused role. This exam validates an examinee’s comprehensive understanding of using AWS services to design, build, secure, and maintain analytics solutions that provide insight from data. In this certification course is geared for people who want to enhance their skills in AWS to help organizations design and migrate their architecture to the cloud.</p>
                    ...
                    <div class="content">
                        ...
                        <div class="topic-content">
                            ...
                            <ul>
                                ...
                                <li>Define a data lifecycle based on usage patterns and business requirement</li>
                        ...
                        <div class="topic-content">
                            <h6>Analysis and Visualization</h6>
                            <ul>
                                <li>Determine the operational characteristics of an analysis and visualization solution</li>
                                <li>Select the appropriate data analysis solution for a given scenario</li>
                                <li>Select the appropriate data visualization solution for a given scenario</li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/aws-certified-data-analytics-speciality.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
