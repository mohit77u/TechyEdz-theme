        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>Azure Administration (AZ-104)</h2>
                    <div class="ratings">
                        <div class="star">
                    ...
                    <p class="para">This course is for Azure Administrators. Azure Administrators manage the cloud services that span storage, networking and compute cloud capabilities, with a deep understanding of each service across the full IT lifecycle. They take end-user requests for new cloud applications and make recommendations on services to use for optimal performance and scale, as well as provision, size, monitor and adjust as appropriate. This role requires communicating and coordinating with vendors. Azure Administrators use the Azure Portal and as they become more proficient they use PowerShell and the Command Line Interface.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/azure-administration-az-104.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/azure-administration-az-104.jpg" alt="azure-administration-az-104">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>This course is for Azure Administrators. Azure Administrators manage the cloud services that span storage, networking and compute cloud capabilities, with a deep understanding of each service across the full IT lifecycle. They take end-user requests for new cloud applications and make recommendations on services to use for optimal performance and scale, as well as provision, size, monitor and adjust as appropriate. This role requires communicating and coordinating with vendors. Azure Administrators use the Azure Portal and as they become more proficient they use PowerShell and the Command Line Interface.</p>
                            <p>The AZ-104 exam replaces the AZ-103 exam, which will be retired on August 31, 2020. This exam is part of Microsoft’s role-based certification program. Candidates who pass the AZ-104 exam will earn the Microsoft Certified: Azure Administrator Associate certification.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Manage role-based access control (RBAC)</h6>
                            <ul>
                        ...
                        <div class="topic-content">
                            <h6>Manage subscriptions and governance</h6>
                            <ul>
                        ...
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/azure-administration-az-104.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>The Azure Administrator certification course requires professionals to be proficient in using PowerShell and the Command Line Interface</li>
                                <li>Should also have prior experience with Azure Portal, ARM templates, operating systems, virtualization, cloud infrastructure, storage structures, and networking</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>Those who want to pursue the Azure Administrator certification</li>
                            <li>Those who want to pass the Microsoft exam AZ-104</li>
                            <li>The Azure Administrator course is best suited for Azure administrators and engineers, system administrators looking to expand into Azure, and IT professionals</li>
                        </ul>
                    </div>
                </div>
            </div>
