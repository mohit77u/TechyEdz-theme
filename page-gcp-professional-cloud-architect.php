        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>GCP Professional Cloud Architect Course Contents </h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>4375 Ratings (4.4)</p>
                    </div>
                    <p class="para">A Professional Cloud Architect enables organizations to leverage Google Cloud technologies. With a thorough understanding of cloud architecture and Google Cloud Platform, this individual can design, develop, and manage robust, secure, scalable, highly available, and dynamic solutions to drive business objectives.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/gcp-professional-cloud-architect.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/gcp-professional-cloud-architect.jpg" alt="gcp-professional-cloud-architect">
            </div>
        </div>
    </div>
</section>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h4>Designing and planning cloud solution architecture </h4>
                            <h6>Designing a solution infrastructure that meets business requirements. Considerations include</h6>
                            <ul>
                                <li>Business use cases and product strategy </li>
                                <li>Cost optimization </li>
                                <li>Supporting the application design </li>
                                <li>Integration with external systems </li>
                                <li>Movement of data </li>
                                <li>Design decision trade-offs </li>
                                <li>Build, buy, or modify </li>
                                <li>Success measurements (e.g., key performance indicators [KPI], return on investment [ROI], metrics</li>
                                <li>Compliance and observability </li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Designing a solution infrastructure that meets technical requirements. Considerations include</h6>
                            <ul>
                                <li>High availability and failover design </li>
                                <li>Elasticity of cloud resources </li>
                                <li>Scalability to meet growth requirements </li>
                                <li>SPerformance and latency </li>
                            </ul>
                            <h6>Designing network, storage, and compute resources. Considerations include</h6>
                            <ul>
                                <li>Integration with on-premises/multi-cloud environments </li>
                                <li>Cloud-native networking (VPC, peering, firewalls, container networking) </li>
                                <li>Choosing data processing technologies </li>
                                <li>Choosing appropriate storage types (e.g., object, file, RDBMS, NoSQL, NewSQL) </li>
                                <li>Choosing compute resources (e.g., preemptible, custom machine type, specialized workload) </li>
                                <li>Mapping compute needs to platform products </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/gcp-professional-cloud-architect.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>Strong knowledge on GCP Associate Cloud Engineer </li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>3+ years of industry experience including 1+ years designing and managing solutions using GCP</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h3>Certification</h3>
                    <p>GCP Professional Cloud Architect (GCP PCA) </p>
                </div>
            </div>
        </div>
    </section>
