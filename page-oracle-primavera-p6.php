        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>Oracle Primavera P6 Certification Training </h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>4475 Ratings (4.2)</p>
                    </div>
                    <p class="para">This course provides in-depth project management training in Primavera’s client/serverbased solution. Building off skills learned in the fundamentals course, the P6 Professional – Advanced course covers advanced subjects such as earned value analysis, resource and role analysis, resource assignments, resource levelling, and global changes. Hands-on enable students to apply skills learned throughout the course.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/oracle-primavera-p6.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/oracle-primavera-p6.png" alt="oracle-primavera-p6">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>This course provides in-depth project management training in Primavera’s client/serverbased solution. Building off skills learned in the fundamentals course, the P6 Professional – Advanced course covers advanced subjects such as earned value analysis, resource and role analysis, resource assignments, resource levelling, and global changes. Hands-on enable students to apply skills learned throughout the course.</p>
                            <p>Demand for Primavera P6 Professional schedulers is growing in the Engineering and Construction industry. Primavera P6 is the standard project management software tool used worldwide in industries such as Construction, Oil & Gas, Manufacturing, Energy and even IT. While there are lots of project management tools on the market, Primavera P6 shines in being able to manage large and complex projects and to do it well. Many contractors are being required to provide schedules and reports in Primavera P6 Professional formats. To help meet this demand, our Primavera P6 Professional Fundamentals training class focuses specifically on the needs of engineering and construction professionals looking to learn Primavera P6 Professional.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h5>Primavera P6 Professional Fundamentals </h5>
                            <h6>Introduction & Learning Objectives </h6>
                            <ul>
                                <li>The Project Management Life-cycle </li>
                            ...
                            <h6>Getting to know Primavera P6 Professional </h6>
                            <ul>
                                <li>P6 user interface and navigation </li>
                                <li>Customizing the P6 views and layouts </li>
                            </ul>
                            <h6>The Enterprise Project Structure (EPS) </h6>
                            <ul>
                                <li>Understanding the purpose of the Enterprise Project Structure </li>
                                <li>Modifying the Enterprise Project Structure </li>
                            </ul>
                            <h6>Project Creation </h6>
                            <ul>
                                <li>Creating a new project </li>
                                <li>Understanding the project status options </li>
                                <li>Modifying project settings </li>
                                <li>Creating and using project codes </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/oracle-primavera-p6.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>Knowledge of project management principles and experience with Windows operating system </li>
                                <li>Advance Excel Topics for reporting </li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>Program Managers, Project Managers, Planners/Schedulers </li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h3>Certification</h3>
                    <p>Primavera P6 Enterprise Project Portfolio Management 8 Essentials 1Z0-567 </p>
                </div>
            </div>
        </div>
    </section>
