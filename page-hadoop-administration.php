        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>Big Data Hadoop Administration </h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>4875 Ratings (4.8)</p>
                    </div>
                    <p class="para">Hadoop Administration Certification Training provides you with proficiency in all the steps required to operate and sustain a Hadoop Cluster which includes Planning, Installation, and Configuration through load balancing, Security, and Tuning. In this training will provide hands-on preparation for the real-world challenges faced by Hadoop Administrators. The course curriculum follows Apache Hadoop distribution.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/hadoop-administration.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/hadoop-administration.jpg" alt="hadoop-administration">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>Hadoop Administration Certification Training provides you with proficiency in all the steps required to operate and sustain a Hadoop Cluster which includes Planning, Installation, and Configuration through load balancing, Security, and Tuning. In this training will provide hands-on preparation for the real-world challenges faced by Hadoop Administrators. The course curriculum follows Apache Hadoop distribution.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Understanding Big Data and Hadoop </h6>
                            <ul>
                                <li>Introduction to big data </li>
                                <li>Common big data domain scenarios </li>
                                <li>Limitations of traditional solutions </li>
                                <li>What is Hadoop? </li>
                                <li>Hadoop 1.0 ecosystem and its Core Components </li>
                                <li>Hadoop 2.x ecosystem and its Core Components </li>
                                <li>Application submission in YARN </li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Hadoop Cluster and its Architecture </h6>
                            <ul>
                                <li>Hadoop Cluster Architecture </li>
                                <li>Replication rules </li>
                                <li>Hadoop Cluster Modes </li>
                                <li>Rack awareness theory </li>
                                <li>Hadoop cluster administrator responsibilities </li>
                                <li>Understand working of HDFS </li>
                                <li>NTP server </li>
                                <li>Initial configuration required before installing Hadoop </li>
                                <li>Deploying Hadoop in a pseudo-distributed mode </li>
                            </ul>
                            <h6>Hadoop Cluster Setup and Working </h6>
                            <ul>
                                <li>OS Tuning for Hadoop Performance </li>
                                <li>Pre-requisite for installing Hadoop </li>
                                <li>Hadoop Configuration Files </li>
                                <li>Stale Configuration </li>
                                <li>RPC and HTTP Server Properties </li>
                                <li>Properties of Namenode, Datanode and Secondary Namenode </li>
                                <li>Log Files in Hadoop </li>
                                <li>Deploying a multi-node Hadoop cluster </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/hadoop-administration.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <p>Basic knowledge of Linux command line interface will be considered beneficial </p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <p>The market for Big Data analytics is constantly growing across the world and this strong growth pattern translates into a great opportunity for all the IT Professionals with the required skills. Hadoop Admin Certification Training helps you to grab this opportunity and accelerate your career. It is best suited for:</p>
                        <ul>
                            <li>Linux / Unix Administrators </li>
                            <li>Data Engineers & Database Administrators </li>
                            <li>Windows Administrators </li>
                            <li>Infrastructure Administrators </li>
                            <li>System Administrators </li>
                            <li>Data Analytics Administrators </li>
                            <li>Cloud Systems Administrators </li>
                            <li>Web Engineers </li>
                            <li>Individuals who intend to design, deploy and maintain Hadoop clusters </li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h3>Certification</h3>
                    <p>Cloudera Certified Administrator for Apache Hadoop ( CCAH / CCA 410) </p>
                </div>
            </div>
        </div>
    </section>
