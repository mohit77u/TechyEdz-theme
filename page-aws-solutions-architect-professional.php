            ...
            <div class="col-sm-8">
                <div class="course-details">
                    ...
                    <div class="ratings">
                        ...
                        <p>3125 Ratings (4.8)</p>
                    </div>
                    <p class="para">Specifically designed to help you prepare for the AWS Solutions Architect - Professional Certification, this hands-on oriented Learning Path provides over 50 hours of interactive content comprised of hands-on labs and a preparation exam. This training content has been carefully created to help you study for this AWS certification. The certification demands that the candidate demonstrates the ability to architect and deploy AWS solutions for different scenarios following AWS's best practices.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/aws-solutions-architect-professional.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/aws-solutions-architect-professional.png" alt="aws-solutions-architect-professional">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>The AWS Solution Architect Professional Certification requires its candidates to be comfortable architecting, securing, migrating, optimizing deployments and managing full production operations on AWS.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Overview of AWS Essentials</h6>
                            <ul>
                                <li>AWS Accounts</li>
                                <li>Regions, AZs, and Edge Infrastructure</li>
                                <li>High Availability, Fault Tolerance, and Disaster Recovery</li>
                                <li>Disaster Recovery: RPO and RTO</li>
                                <li>Data Persistence</li>
                                <li>The OSI 7-Layer Networking Model</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Accounts</h6>
                            <ul>
                                <li>Accounts Introduction</li>
                                <li>IAM Overview</li>
                                <li>Identity and Resource Policies</li>
                                <li>IAM Roles and Temporary Security Credentials</li>
                                <li>Cross-Account Access: Resource Permissions vs. Cross-Account Roles</li>
                                <li>Accessing S3 with AWS IAM Roles</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Account Management</h6>
                            <ul>
                                <li>AWS Accounts and AWS Organizations</li>
                                <li>Service Control Policies</li>
                                <li>AWS Account Limits</li>
                                <li>AWS Support Tiers</li>
                                <li>AWS Config</li>
                                <li>AWS Service Catalog</li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/aws-solutions-architect-professional.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                ...
                                <li>2 or more years of hands-on experience designing and deploying cloud architecture on AWS</li>
                                ...
                                <li>Ability to provide best practice guidance on the architectural design across multiple applications and projects of the enterprise</li>
                                <li>Familiarity with a scripting language</li>
                                <li>Familiarity with Windows and Linux environments</li>
                                <li>Familiarity with AWS CLI, AWS APIs, AWS Cloud Formation templates, the AWS Billing Console, and the AWS Management Console</li>
                                <li>Explain and apply the five pillars of the AWS Well-Architected Framework</li>
                                <li>Map business objectives to application/architecture requirements</li>
                                <li>Design a hybrid architecture using key AWS technologies (e.g., VPN, AWS Direct Connect)</li>
                                <li>Architect a continuous integration and deployment process</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>This learning path is suitable for those wanting to pass the AWS Solutions Architect - Professional Certification Exam</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h3>Certification</h3>
                    <p>AWS Certified Solutions Architect – Professional (SAP-C01)</p>
                </div>
            </div>
        </div>
    </section>
