        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>VMware Horizon View 7: Install, Configure, Manage [V7.10] </h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>4275 Ratings (4.6)</p>
                    </div>
                    <p class="para">This hands-on course gives you the skills to deliver virtual desktops and applications through a single virtual desktop infrastructure platform. This course builds your skills in installing, configuring, and managing VMware Horizon® 7 through a combination of lecture and hands-on labs. You learn how to configure and deploy pools of virtual machines, how to manage the access and security of the machines, and how to provide a customized desktop environment to end users.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/vmware-horizon-view.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/vmware-horizon-view.png" alt="vmware-horizon-view">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>This hands-on course gives you the skills to deliver virtual desktops and applications through a single virtual desktop infrastructure platform. This course builds your skills in installing, configuring, and managing VMware Horizon® 7 through a combination of lecture and hands-on labs. You learn how to configure and deploy pools of virtual machines, how to manage the access and security of the machines, and how to provide a customized desktop environment to end users.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            ...
                            <h6>Introduction to VMware Horizon </h6>
                            <ul>
                                ...
                                <li>Convert customer requirements to use case attributes </li>
                            </ul>
                            <h6>Horizon Connection Server </h6>
                            <ul>
                                <li>Recognize VMware Horizon reference architecture </li>
                                <li>Identify the recommended system requirements for Horizon Connection Server </li>
                                <li>Identify the recommended virtualization requirements for a Horizon® Connection ServerTM instance </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/vmware-horizon-view.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <p>Attendees should have, at a minimum, the following VMware infrastructure skills: </p>
                            <ul>
                                <li>Use VMware vSphere® Web Client to view the state of virtual machines, datastores, and networks </li>
                                <li>Open a virtual machine console on VMware vCenter Server® and access the guest operating system </li>
                                <li>Create snapshots of virtual machines </li>
                                <li>Configure guest customization specifications </li>
                                <li>Modify virtual machine properties </li>
                                <li>Convert a virtual machine into a template </li>
                                <li>Deploy a virtual machine from a template </li>
                            </ul>
                            <p>Attendees should also have the following Microsoft Windows system administration experience: </p>
                            <ul>
                                <li>Configure Active Directory services, including DNS, DHCP, and time synchronization </li>
                                <li>Restrict user activities by implementing Group Policy objects </li>
                                <li>Configure Windows systems to enable Remote Desktop Connections </li>
                                <li>Build an ODBC connection to an SQL Server database </li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>Technical personnel who work in the IT departments of end-customer companies and people who are responsible for the delivery of remote or virtual desktop services</li>
                            <li>System administrators and system integrators responsible for deploying the VMware virtual desktop infrastructure </li>
                        </ul>
                    </div>
                </div>
            </div>
