            ...
            <div class="col-sm-8">
                <div class="course-details">
                    ...
                    <div class="ratings">
                        ...
                        <p>4375 Ratings (4.7)</p>
                    </div>
                    <p class="para">Data Analytics course curriculum provides extensive knowledge of Data Collection, Extraction, Cleansing, Exploration, and Transformation. Alongside the Data Mining, Data Integration is done with feature Engineering to build Prediction models for Data Visualization and deploying the solution. You name the skill set and our trainers are always there to handle the new generation tools with latest versions.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/data-analytics.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/data-analytics.jpg" alt="data-analytics">
            </div>
        </div>
    </div>
</section>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Data Science Project Lifecycle</h6>
                            <ul>
                                <li>Recap of Demo </li>
                                <li>Introduction to Types of Analytics</li>
                                <li>Project life cycle </li>
                                <li>An introduction to our E learning platform </li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Introduction To Basic Statistics Using R And Python </h6>
                            <ul>
                                <li>Data Types </li>
                                ...
                                <li>R</li>
                                <li>R Studio </li>
                                <li>Descriptive Stats in R </li>
                                <li>Python (Installation and basic commands) and Libraries </li>
                                <li>Jupyter note book </li>
                                <li>Set up Github </li>
                                <li>Descriptive Stats in Python </li>
                                <li>Pandas and Matplotlib / Seaborn </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/cypress.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>Some programming experience (preferred) </li>
                                <li>Structured thinking approach </li>
                                <li>Passion for solving problems </li>
                                <li>Willingness to learn statistical concepts </li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>Professionals or fresher’s who are really serious about making a career in Data Analytics can do this course </li>
                            <li>Individuals from any domain who possess logical thinking about mathematical and analytical skills</li>
                            <li>People who are working on business intelligence tools, data warehousing and reporting tools</li>
                            ...
                            <li>Freshers from any stream with good analytical and logical skills</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h3>Certification</h3>
                    <p>Associate Certified Analytics Professional (aCAP) </p>
                    <p>Certified Analytics Professional (CAP) </p>
                </div>
            </div>
        </div>
    </section>
