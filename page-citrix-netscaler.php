        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>Citrix ADC (Citrix NetScaler)</h2>
                    <div class="ratings">
                        <div class="star">
                    ...
                    <p class="para">Learn the skills required to implement Citrix ADC Essential components including secure Load Balancing, High Availability, and Citrix ADC Management. At the end of the course, students will be able to configure their Citrix ADC environments to address traffic delivery and management requirements including Load Balancing, Availability, and ADC Operation Management.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/citrix-netscaler.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/citrix-netscaler.jpg" alt="citrix-netscaler">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            ...
                            <ul>
                                <li>Introduction to the NetScaler System</li>
                                <li>TriScale </li>
                                <li>NetScaler Use Cases </li>
                                <li>NetScaler Functionality </li>
                                <li>NetScaler Overview </li>
                                <li>Product Features </li>
                                <li>NetScaler Operating System Overview </li>
                                <li>nCore Configuration Architecture </li>
                                <li>NetScaler File system </li>
                                <li>Deployment Scenarios </li>
                                <li>Logging in to the NetScaler System </li>
                                <li>NetScaler Licenses </li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Basic Networking</h6>
                            <ul>
                                <li>OSI Networking Model </li>
                                <li>NetScaler Architecture Overview </li>
                                <li>NetScaler-Owned IP Addresses </li>
                                <li>Network Topology </li>
                                <li>NetScaler Network Interfaces </li>
                                <li>Virtual Local Area Networks (VLANs) </li>
                                <li>IP Routing </li>
                                <li>Determining the Source IP Address </li>
                                <li>Packet Forwarding </li>
                                <li>Use Source IP Mode </li>
                                <li>Client-IP HTTP Header Insertion </li>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>IT Professionals working with Citrix ADC, with little or no previous ADC experience</li>
                            <li>Potential students include administrators, engineers, and architects interested in learning how to deploy or manage Citrix ADC</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h3>Certification</h3>
                    <p>AWS Certified Solutions Architect – Associate (SAA-C02)</p>
                </div>
            </div>
        </div>
    </section> -->
