        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>G Suite End User Training</h2>
                    <div class="ratings">
                        <div class="star">
                    ...
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/g-suite-end-user.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/g-suite.png" alt="g-suite-end-user">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Gmail</h6>
                            <ul>
                                <li>Add a profile picture to your email </li>
                                <li>Add a background theme to your inbox </li>
                                <li>Create events right from your inbox </li>
                                <li>Get your daily agenda in your inbox </li>
                                <li>Undo sending your mail </li>
                                <li>Create email templates </li>
                                <li>Compose a smart email</li>
                                <li>Mute email conversations </li>
                                <li>Send & save large attachments in Drive </li>
                                <li>Automatically add events from Gmail </li>
                                <li>Schedule email to send later </li>
                                <li>Correct spelling and grammar in Gmail </li>
                                <li>See new messages at the top of a thread </li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Google Drive</h6>
                            <ul>
                                <li>Send & save large attachments in Drive </li>
                                <li>Access stored Drive files offline </li>
                                <li>Create document templates </li>
                                <li>See changes in Drive files & folders </li>
                                <li>Switch to a different version of your file </li>
                                <li>Share links to PDF versions of your files </li>
                                <li>Work with Microsoft Office files </li>
                                <li>See who's editing an Office file </li>
                                <li>Complete PDF forms using a mobile device </li>
                                <li>Find files and folders with shortcuts </li>
                                <li>Find and act on unresolved comments </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/g-suite-end-user.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
