        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    ...
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/salesforce-admin-development.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/salesforce-admin-development.png" alt="salesforce-admin-development">
            </div>
        </div>
    </div>
</section>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Introduction to CRM</h6>
                            <ul>
                                <li>Why CRM? </li>
                                <li>Introduction to Cloud Computing & Salesforce.com </li>
                            ...
                            <h6>What is Salesforce.com? </h6>
                            <ul>
                                <li>Salesforce.com CRM Editions </li>
                                <li>Salesforce Architecture – Cloud Computing is a Better Model Multi-tenant </li>
                                <li>Salesforce Editions / Pricing </li>
                            </ul>
                            <h6>Salesforce.com Navigation - Overview</h6>
                            <ul>
                                <li>Salesforce Certifications </li>
                                <li>Certified Force.com Developer(401) </li>
                                <li>Certified Administration (201) </li>
                                <li>Certified Advanced Force.com Developer(501), etc., </li>
                            </ul>
                            <h6>Database Introduction</h6>
                            <ul>
                                ...
                                <li>Custom Objects Vs. Standard Objects </li>
                                <li>Create custom Fields </li>
                                <li>Create custom Tabs </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/salesforce-admin-development.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
