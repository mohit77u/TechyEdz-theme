            ...
            <div class="col-sm-8">
                <div class="course-details">
                    ...
                    <div class="ratings">
                        ...
                        <p>4275 Ratings (4.3)</p>
                    </div>
                    <p class="para">EMC SAN is a Storage Area Network offered by EMC Corporation. SAN (Storage Area Network), a high-speed and secure network that is used for secure data transmission and storage. By comprising diversified products and services, EMC SAN is engaged in giving access to storage devices to a number of requested servers. EMC SAN covers network operations of a complete storage area based-on a Connectrix family of switches.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/emc-san-administration.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/emc-san-administration.jpg" alt="emc-san-administration">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>EMC SAN is a Storage Area Network offered by EMC Corporation. SAN (Storage Area Network), a high-speed and secure network that is used for secure data transmission and storage. By comprising diversified products and services, EMC SAN is engaged in giving access to storage devices to a number of requested servers. EMC SAN covers network operations of a complete storage area based-on a Connectrix family of switches. It comprises various operations like performance levels monitoring operations, determining security as well as troubleshooting. It supports SMEs as well as organizations in Managing IT expenses, data availability, consolidated infrastructure storage, data backup services, business continuity, direct and network attached storage.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>VMware VSphere VCenter</h6>
                            <ul>
                                <li>Install and configure VMware ESX™/ESXi, vCenter™ Server, vCenter Converter, vCenter Server Heartbeat, Data Recovery, and vCenter Update Manager</li>
                                <li>Configure and manage vSphere networking and storage from both graphical and command-line interfaces </li>
                                <li>Create, configure, migrate, convert, monitor, patch, and back up virtual machines and virtual appliances</li>
                                <li>Use VMware Distributed Resource Scheduler (DRS) to automate resource management</li>
                                <li>Implement high availability and fault-tolerance solutions</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Storage Basic & Advanced Concepts</h6>
                            <ul>
                                <li>Explain Storage Fundamentals </li>
                                <li>Describe Network Attach Storage (NAS) </li>
                                <li>Describe Network Attached Storage (NAS) </li>
                                <li>Compare Direct Attach Storage (DAS) to Network Attach Storage (NAS) </li>
                                <li>Identify the components and uses of a Storage Area Networks (SAN) </li>
                                <li>HBA vs NIC</li>
                                <li>Hub/Loop Switches, Fabric Switches, Directors</li>
                                <li>FLOGI, SCN, RSCN, SNS</li>
                                <li>JBOD, Tape Libraries, Storage Drives, Storage Arrays</li>
                                <li>Classify SAN Applications </li>
                                <li>Explanation & Implementation of Fibre Channel (FC) Protocol? </li>
                                <li>Explanation & Implementation of iSCSI protocol</li>
                                <li>FCoE vs FCIP</li>
                                <li>Categorize Storage Networking Issues </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/emc-san-administration.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>Basic knowledge of storage area networks and the candidate are suggested to have an idea of network installation and configuration.</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>Unix System Administrators working on Enterprise servers </li>
                            <li>Customer Support Engineer </li>
                            <li>Technical Consultant </li>
                            <li>Fresher’s with Computer Science Background </li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h3>Certification</h3>
                    <p>Dell EMC Proven Professional certification program overview: </p>
                    <p>Information Storage Associate (EMCISA) </p>
                    <p>Data Scientist Associate (EMCDSA) </p>
                    <p>Data Scientist (EMCDS) </p>
                    <p>Cloud Infrastructure and Services Associate Version 2 (EMCCIS) </p>
                    <p>Cloud Architect (EMCCA) </p>
                    <p>Data Protection and Management Associate (EMCDPM) </p>
                </div>
            </div>
        </div>
    </section>
