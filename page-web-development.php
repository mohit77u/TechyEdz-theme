            ...
            <div class="col-sm-8">
                <div class="course-details">
                    ...
                    <div class="ratings">
                        ...
                        <p>4795 Ratings (4.8)</p>
                    </div>
                    <p class="para">We offers Web Development training courses. Students will learn the skills necessary to become a Back-End Engineer, Front-End Engineer, or a Full-Stack Engineer. After completing the courses, you will be able to design web pages for both static and dynamic websites with latest technologies. The package also includes courses on Professional Web Designing with HTML & CSS, Object Oriented JavaScript, Bootstrap Framework,  and backend technologies like Angular JS, Node JS and Mongo DB.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/web-development.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>We offers Web Development training courses. Students will learn the skills necessary to become a Back-End Engineer, Front-End Engineer, or a Full-Stack Engineer. After completing the courses, you will be able to design web pages for both static and dynamic websites with latest technologies. The package also includes courses on Professional Web Designing with HTML & CSS, Object Oriented JavaScript, Bootstrap Framework,  and backend technologies like Angular JS, Node JS and Mongo DB. </p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <ul>
                                ...
                                <li>HTML Syntax 
                                    <ul>
                                        ...
                                        <li>HTML Offline Applications </li>
                                        <li>HTML Geo-location </li>
                                        <li>HTML Web Workers </li>
                                        <li>HTML5 Web sockets </li>
                                        <li>HTML5 Messaging API </li>
                                        <li>HTML5 Working with Drag and Drop </li>
                                    </ul>
                                </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/web-development.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>This course doesn't require any prior programming knowledge. Basic computer science knowledge will be enough to get started with this course</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>This course can be taken by anyone who wants to learn the art of web development. Besides this anyone who wants to create stunning websites using HTML5, CSS3, Twitter Bootstrap 3 and jQuery can take this course</li>
                        </ul>
                    </div>
                </div>
            </div>
