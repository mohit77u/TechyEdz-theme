            ...
            <div class="col-sm-8">
                <div class="course-details">
                    ...
                    <div class="ratings">
                        ...
                        <p>21600 Ratings (4.3)</p>
                    </div>
                    <p class="para">The AWS Certified Cloud Practitioner (CLF-C01) examination is intended for individuals who have the knowledge, skills, and abilities to demonstrate basic knowledge of the AWS platform, including: available services and their common use cases, AWS Cloud architectural principles (at the conceptual level), account security, and compliance. The candidate will demonstrate an understanding of AWS Cloud economics including: costs, billing, and analysis, and the value proposition of the AWS Cloud.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/aws-certified-cloud-practitioner.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/aws-certified-cloud-practitioner.jpg" alt="aws-certified-cloud-practitioner">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>The AWS Certified Cloud Practitioner (CLF-C01) examination is intended for individuals who have the knowledge, skills, and abilities to demonstrate basic knowledge of the AWS platform, including: available services and their common use cases, AWS Cloud architectural principles (at the conceptual level), account security, and compliance. The candidate will demonstrate an understanding of AWS Cloud economics including: costs, billing, and analysis, and the value proposition of the AWS Cloud.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Cloud Concepts</h6>
                            <ul>
                                <li>Define the AWS Cloud and its value proposition</li>
                                <li>Identify aspects of AWS Cloud economics</li>
                                <li>List the different cloud architecture design principles</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Security and Compliance</h6>
                            <ul>
                                <li>Define the AWS shared responsibility model</li>
                                <li>Define AWS Cloud security and compliance concepts</li>
                                <li>Identify AWS access management capabilities</li>
                                <li>Identify resources for security support</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Technology</h6>
                            <ul>
                                <li>Define methods of deploying and operating in the AWS Cloud</li>
                        ...
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/aws-certified-cloud-practitioner.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>Candidates should have a basic understanding of IT services and their uses in the AWS Cloud platform</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>Those intending to gain AWS Certified Cloud Practitioner certification</li>
                            <li>Those who need to gain high level overview of Amazon Web Services</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h3>Certification</h3>
                    <p>AWS Certified Cloud Practitioner (CLF-C01)</p>
                </div>
            </div>
        </div>
    </section>
