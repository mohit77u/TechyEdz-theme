        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>Bigdata Hadoop Development </h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>4805 Ratings (4.7)</p>
                    </div>
                    <p class="para">Hadoop Development course teaches the skill set required for the learners how to setup Hadoop Cluster, how to store Big Data using Hadoop (HDFS) and how to process/analyze the Big Data using Map-Reduce Programming or by using other Hadoop ecosystems. Hadoop course will equip you with all the skills you’ll needfor your next Big Data assignment. You will learn to work with Hadoop’s Distributed File System, its processing and computation frameworks, core Hadoop distributions, and vendor-specific distributions such as Cloudera. You will learn the need for cluster management solutions and how to set up, secure, safeguard and monitor clusters and their components such as Sqoop, Flume, Pig, Hive and Hbase with this Big Data Hadoop course.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/hadoop-development.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/hadoop-development.jpg" alt="hadoop-development">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>Hadoop Development course teaches the skill set required for the learners how to setup Hadoop Cluster, how to store Big Data using Hadoop (HDFS) and how to process/analyze the Big Data using Map-Reduce Programming or by using other Hadoop ecosystems. Hadoop course will equip you with all the skills you’ll needfor your next Big Data assignment. You will learn to work with Hadoop’s Distributed File System, its processing and computation frameworks, core Hadoop distributions, and vendor-specific distributions such as Cloudera. You will learn the need for cluster management solutions and how to set up, secure, safeguard and monitor clusters and their components such as Sqoop, Flume, Pig, Hive and Hbase with this Big Data Hadoop course.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Introduction to BigData, Hadoop </h6>
                            <ul>
                                ...
                                <li>HDFS, MapReduce, PIG, Hive, SQOOP, HBASE, OOZIE, Flume, Zookeeper and so on</li>
                                <li>What is the scope of Hadoop? </li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Deep Drive in HDFS (for Storing the Data) </h6>
                            <ul>
                                ...
                                <li>Data Node </li>
                                <li>Task Tracker </li>
                                <li>Anatomy of File Wright </li>
                                <li>Anatomy of File Read </li>
                                ...
                                <li>Blocks and Replication </li>
                                <li>Rack Awareness </li>
                                <li>Heartbeat Signal </li>
                                <li>How to Store the Data into HDFS </li>
                                <li>How to Read the Data from HDFS </li>
                                <li>Accessing HDFS (Introduction of Basic UNIX commands) </li>
                                <li>CLI commands </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/hadoop-development.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>Working professionals in IT / Analytics / Statistics / Big Data / Machine Learning </li>
                            <li>Fresh graduates from Engineering / Mathematics / IT backgrounds </li>
                            <li>Professionals looking to develop skills to do statistical analysis to support decision making </li>
                        </ul>
                    </div>
                </div>
            </div>
