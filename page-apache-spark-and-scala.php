            ...
            <div class="col-sm-8">
                <div class="course-details">
                    ...
                    <div class="ratings">
                        ...
                        <p>1965 Ratings (4.3)</p>
                    </div>
                    <p class="para">This training course delivers the key concepts and expertise developers need to use Apache Spark to develop high-performance parallel applications. Participants will learn how to use Spark SQL to query structured data and Spark Streaming to perform real-time processing on streaming data from a variety of sources. Developers will also practice writing applications that use core Spark to perform ETL processing and iterative algorithms.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/apache-spark-and-scala.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/apache-spark-and-scala.jpg" alt="active-directory-services-with-windows-server">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>This training course delivers the key concepts and expertise developers need to use Apache Spark to develop high-performance parallel applications. Participants will learn how to use Spark SQL to query structured data and Spark Streaming to perform real-time processing on streaming data from a variety of sources. Developers will also practice writing applications that use core Spark to perform ETL processing and iterative algorithms.</p>
                            <p>The course covers how to work with “big data” stored in a distributed file system, and execute Spark applications on a Hadoop cluster. After taking this course, participants will be prepared to face real-world challenges and build applications to execute faster decisions, better decisions, and interactive analysis, applied to a wide variety of use cases, architectures, and industries.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Introduction to Apache Hadoop and the Hadoop Ecosystem</h6>
                            <ul>
                                <li>Apache Hadoop Overview</li>
                                <li>Data Processing</li>
                                <li>Introduction to the Hands-On Exercises</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Apache Hadoop File Storage</h6>
                            <ul>
                                <li>Apache Hadoop Cluster Components</li>
                                <li>HDFS Architecture</li>
                                <li>Using HDFS</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Distributed Processing on an Apache Hadoop Cluster</h6>
                            <ul>
                                <li>YARN Architecture</li>
                                <li>Working With YARN</li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Apache Spark Basics</h6>
                            <ul>
                                <li>What is Apache Spark?</li>
                                <li>Starting the Spark Shell</li>
                                <li>Using the Spark Shell</li>
                                <li>Getting Started with Datasets and DataFrames</li>
                                <li>DataFrame Operations</li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/apache-spark-and-scala.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="like">
        <div class="container">
            ...
            <div id="prerequisites" class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/apache-spark-and-scala.jpg" alt="apache-spark-and-scala">
            </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <p>This course is designed for developers and engineers who have programming experience, but prior knowledge of Spark and Hadoop is not required. Apache Spark examples and hands-on exercises are presented in Scala and Python. The ability to program in one of those languages is required. Basic familiarity with the Linux command line is assumed. Basic knowledge of SQL is helpful.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <p>The Apache Kafka course is suitable for many roles, including:</p>
                        <ul>
                            <li>Professionals aspiring for a career in Big Data</li>
                            <li>Analytics professionals, research professionals, IT developers, testers and project managers</li>
                            <li>Students</li>
                            <li>Individuals looking for a change in career</li>
                        </ul>
                    </div>
                </div>
            </div>
