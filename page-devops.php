                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>DevOps Certification Training Course will enable you to prepare you for a career in DevOps, a fast-growing field that bridges the gap between software developers and operations professionals. This DevOps Training is to make an individual expert in all DevOps Concepts form the Basics. This  Course is Provided by the Real-Time professionals to make you understand the Real-Time IT Scenario’s and Problems. DevOps Training makes you master in the various aspects of the principles of continuous development and deployment, software development operations, continuous integration, automation of configuration management and learn the various tools like Git, Docker, Jenkins, Nagios, Puppet, Ansible and Kubernetes.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="content">
                        ...
                        <div class="topic-content">
                            ...
                            <ul>
                                ...
                                <li>Containers and Virtual Development  
                                    <ul>
                                        <li>Docke</li>
                                        <li>Vagrant </li>
                                    </ul>
                        ...
                        <div class="topic-content">
                            ...
                            <ul>
                                ...
                                <li>Private, Public and Hybrid Cloud </li>
                                <li>Public Clouds 
                                    <ul>
                        ...
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/devops.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h3>Certification</h3>
                    <p>DevOps Certified Professional </p>
                </div>
            </div>
        </div>
    </section>
