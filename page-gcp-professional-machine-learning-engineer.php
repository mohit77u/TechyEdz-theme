        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>GCP Professional Machine Learning Engineer </h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>4865 Ratings (4.8)</p>
                    </div>
                    <p class="para">A Professional Machine Learning Engineer designs, builds, and productionizes ML models to solve business challenges using Google Cloud technologies and knowledge of proven ML models and techniques. The ML Engineer is proficient in all aspects of model architecture, data pipeline interaction, and metrics interpretation and needs familiarity with application development, infrastructure management, data engineering, and security.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/gcp-professional-machine-learning-engineer.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/gcp-professional-machine-learning-engineer.jpg" alt="gcp-professional-machine-learning-engineer">
            </div>
        </div>
    </div>
</section>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h4>ML Problem Framing </h4>
                            <h6>Translate business challenge into ML use case </h6>
                            <ul>
                                <li>Defining business problems </li>
                                <li>Identifying nonML solutions </li>
                                <li>Defining output use </li>
                                <li>Managing incorrect results </li>
                                <li>Identifying data sources </li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Define ML problem </h6>
                            <ul>
                                <li>Defining problem type (classification, regression, clustering, etc.) </li>
                                <li>Defining outcome of model predictions </li>
                                <li>Defining the input (features) and predicted output format </li>
                            </ul>
                            <h6>Define business success criteria </h6>
                            <ul>
                                <li>Success metrics </li>
                                <li>Key results </li>
                                <li>Determination of when a model is deemed unsuccessful </li>
                            </ul>
                            <h6>Identify risks to feasibility and implementation of ML solution </h6>
                            <ul>
                                <li>Assessing and communicating business impact </li>
                                <li>Assessing ML solution readiness </li>
                                <li>Assessing data readiness </li>
                                <li>Aligning with Google AI principles and practices (e.g. different biases) </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/gcp-professional-machine-learning-engineer.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="prerequisites" class="pwnckf" data-spy>
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        <h3>Course Prerequisites: None</h3>
                    </div>
                </div>
            </div>
        </div>
