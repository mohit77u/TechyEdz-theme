        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>Oracle 12C DBA Certification Training </h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>4465 Ratings (4.7)</p>
                    </div>
                    <p class="para">This course will will teach you about the Oracle Database architecture and you will discover how to effectively manage an Oracle Database instance. You will also be provided key information on how to install and administer Oracle Database 12c. It includes various concepts like Oracle DBA Architecture, database structures, memory and process architecture, security, schema objects, data backup and recovery. DBA’s are responsible for the design, implementation, support and maintenance of computerized databases in today’s organizations. They are also responsible for security, performance and availability of data to users and customers. Here we can learn how to operate the stored data and return meaningful results to analyze the data stored. You can also opt these courses to achieve Database administration certification.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/oracle-12c-dba.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/oracle-12c-dba.jpg" alt="oracle-12c-dba">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>This course will will teach you about the Oracle Database architecture and you will discover how to effectively manage an Oracle Database instance. You will also be provided key information on how to install and administer Oracle Database 12c. It includes various concepts like Oracle DBA Architecture, database structures, memory and process architecture, security, schema objects, data backup and recovery. DBA’s are responsible for the design, implementation, support and maintenance of computerized databases in today’s organizations. They are also responsible for security, performance and availability of data to users and customers. Here we can learn how to operate the stored data and return meaningful results to analyze the data stored. You can also opt these courses to achieve Database administration certificatio.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="content">
                        ...
                        <div class="topic-content">
                            ...
                            <ul>
                                ...
                                <li>Overview of Oracle Database 12c </li>
                                <li>Overview of Oracle Cloud </li>
                                <li>Overview of the HR Schema </li>
                                <li>Oracle Database 12c Introduction </li>
                            </ul>
                            <h6>Exploring the Oracle Database Architecture </h6>
                            <ul>
                                <li>Oracle Database Architecture: Overview </li>
                                <li>Oracle Database Instance Configurations </li>
                                <li>Connecting to the Oracle Database Instance </li>
                                <li>Oracle Database memory Structures (overview) </li>
                                <li>Process Architecture </li>
                                <li>Process Structures </li>
                                <li>Process Startup Sequence </li>
                                <li>Database Storage Architecture </li>
                            </ul>
                            <h6>Oracle Software Installation Basics </h6>
                            <ul>
                                <li>Planning Your Installation </li>
                                <li>Configuring Oracle Linux with Oracle RDBMS Pre-Install RPM </li>
                                <li>Operating System Groups and Users </li>
                                <li>Environment Variables </li>
                                <li>Configuring the Oracle Software Owner Environment </li>
                                <li>Using Oracle Universal Installer (OUI) </li>
                                <li>Installation Option: Silent Mode </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/oracle-12c-dba.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>Working knowledge of SQL and use of PL/SQL packages </li>
                            </ul>
                        </div>
                    </div>
                </div>
