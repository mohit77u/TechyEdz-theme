        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>Certified Kubernetes Application Developer (CKAD)</h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>4585 Ratings (4.8)</p>
                    </div>
                    <p class="para">This learning path is designed to help you prepare you for the Certified Kubernetes Application Developer (CKAD) exam. It includes a combination of Courses covering each exam domain, a series of Hands-on Labs to build first-hand Kubernetes experience working directly in a live cloud environment, and exams to test your knowledge along the way.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/kubernetes-application-developer.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/kubernetes-application-developer.jpg" alt="kubernetes-application-developer">
            </div>
        </div>
    </div>
</section>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Multi-Container Pods </h6>
                            <ul>
                                <li>Understand Multi-Container Pod design patterns (e .g. ambassador, adapter, sidecar</li>
                            </ul>
                            <h6>Observability</h6>
                            <ul>
                        ...
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/kubernetes-application-developer.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>A solid understanding of containers, and Docker in particular, will be of value</li>
                                <li>You should be comfortable working with Linux shells. </li>
                                <li>Prior experience working with virtual machines in cloud environments is beneficial but not required</li>
                            </ul>
                        </div>
                    </div>
                </div>
