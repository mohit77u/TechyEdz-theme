        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>Nutanix Enterprise Cloud Administration (ECA) 5.15 </h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>4385 Ratings (4.9)</p>
                    </div>
                    <p class="para">The course covers many of the tasks Nutanix administrators perform through the use of graphical user interfaces (GUIs) and command-line interfaces (CLIs). It also provides insight a Nutanix cluster’s failover and self-healing capabilities, offers tips for solving common problems, and provides guidelines for collecting information when interacting with Nutanix Support.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/nutanix-enterprise-cloud-administration.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/nutanix-enterprise-cloud-administration.jpg" alt="nutanix-enterprise-cloud-administration">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>The course covers many of the tasks Nutanix administrators perform through the use of graphical user interfaces (GUIs) and command-line interfaces (CLIs). It also provides insight a Nutanix cluster’s failover and self-healing capabilities, offers tips for solving common problems, and provides guidelines for collecting information when interacting with Nutanix Support.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Introduction to HCI (Hyper Converged Infrastructure) </h6>
                            <ul>
                                <li>Nutanix Concepts </li>
                                <li>Storage Concepts </li>
                                <li>Nutanix Components </li>
                            </ul>
                            <h6>Managing Nutanix Cluster </h6>
                            <ul>
                                <li>Prism Overview </li>
                                <li>Prism Features </li>
                                <li>Demo Available </li>
                            </ul>
                            <h6>Securing Nutanix Cluster </h6>
                            <ul>
                            ...
                            <ul>
                                ...
                                <li>AHV Host Networking </li>
                                <li>Network Segmentation </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/nutanix-enterprise-cloud-administration.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>Basic Concepts of Data Centre Virtualization </li>
                                <li>Knowledge of managing physical server and storage systems </li>
                                <li>Normal understanding of Cisco routing and switching </li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>Administrators, architects, and business leaders who manage Nutanix clusters in the datacenter </li>
                        </ul>
                    </div>
                </div>
            </div>
