        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>Citrix XenServer 7.1 LTSR Administration</h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>4290 Ratings (4.7)</p>
                    </div>
                    <p class="para">Build a new skill set around Citrix XenServer 7.x focusing on the 7.1 Long Term Services Release, which delivers optimized server virtualization for all datacenter workloads. In this five-day course, you’ll learn how to install, manage, secure, size and troubleshoot an enterprise XenServer implementation. The course will walk you through configuration and administration of the environment, from architecture and virtual machines to resource pools, storage and networking.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/citrix-xenserver-7.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/citrix-xenserver-7.jpg" alt="citrix-xenserver-7">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>Build a new skill set around Citrix XenServer 7.x focusing on the 7.1 Long Term Services Release, which delivers optimized server virtualization for all datacenter workloads. In this five-day course, you’ll learn how to install, manage, secure, size and troubleshoot an enterprise XenServer implementation. The course will walk you through configuration and administration of the environment, from architecture and virtual machines to resource pools, storage and networking. Key topics will include capabilities such as virtual CPU optimization, VM management, and high availability/disaster recovery, and features such as Intellicache and XenMotion. This course is designed for IT professionals with little or no XenServer experience.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Managing Virtual Machines</h6>
                            <ul>
                                ...
                                <li>Managing snapshot </li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Installing XenServer</h6>
                            <ul>
                        ...
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/citrix-xenserver-7.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>This course requires little to no previous experience with Citrix XenServer</li>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>IT Professionals who need to design, deploy, manage, and support Citrix XenServer</li>
                            <li>Potential students include administrators, engineers, or architects working with Citrix XenServer for both XenApp and XenDesktop workloads as well as general infrastructure use</li>
                        </ul>
                    </div>
                </div>
            </div>
