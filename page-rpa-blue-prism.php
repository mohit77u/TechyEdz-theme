            ...
            <div class="col-sm-8">
                <div class="course-details">
                    ...
                    <div class="ratings">
                        ...
                        <p>4935 Ratings (4.4)</p>
                    </div>
                    <p class="para">Blue Prism is one of the tools of the Robotic Process Automation (RPA) that can fetch high for the organization with less effort. The Blue Prism technology can be used by both IT and business industry people with various kind of application user interfaces. NareshIT makes the aspirant to learn all the concepts from basic level to the advanced level of Blue Prism Technology with an ease.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/rpa-blue-prism.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/rpa-blue-prism.jpg" alt="rpa-blue-prism">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>Blue Prism is one of the tools of the Robotic Process Automation (RPA) that can fetch high for the organization with less effort. The Blue Prism technology can be used by both IT and business industry people with various kind of application user interfaces. NareshIT makes the aspirant to learn all the concepts from basic level to the advanced level of Blue Prism Technology with an ease.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="content">
                        ...
                        <div class="topic-content">
                            ...
                            <ul>
                                ...
                                <li>RPA Future </li>
                                <li>RPA Tools Explanation </li>
                            </ul>
                            <h6>Introduction to Blue Prism </h6>
                            <ul>
                                <li>Full Installation of Blue Prism Software with the Server </li>
                                <li>Blue Prism Architecture </li>
                                <li>Blue Prism Dashboard </li>
                                <li>Overview of Blue Prism Modules </li>
                            </ul>
                            <h6>Process Studio </h6>
                            <ul>
                            ...
                            <ul>
                                <li>Circular Path </li>
                                <li>Controlling Play </li>
                                <li>Set Next Stage </li>
                                <li>Break Points </li>
                                <li>Collections and Loops </li>
                                <li>Layers Of Logic </li>
                                <li>Pages For Organization </li>
                                <li>Review </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/rpa-blue-prism.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>Enough knowledge of Network certification </li>
                                <li>Enough knowledge of Windows Server Administrative tasks </li>
                                <li>Anyone with basic programming knowledge like C Language and Java can also do the Blue Prism Training Course </li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            ...
                            <li>Business Process Executives </li>
                            <li>Fresh Graduates can also do the course </li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h3>Certification</h3>
                    <p>Blue Prism Developer Certification </p>
                </div>
            </div>
        </div>
    </section>
