        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>Microsoft Intune Certification Training </h2>
                    <div class="ratings">
                        <div class="star">
                    ...
                    <p class="para">With the proliferation of mobile devices in the workplace, employees can, and do, work from just about anywhere. To stay productive, this mobile workforce demands consistent access to corporate resources and data from any location from any device. This trend has introduced significant challenges for IT administrators who want to enable enterprise mobility while ensuring that corporate resources are protected from unauthorized access. By using Microsoft Intune, you can manage applications and devices from the cloud.  Microsoft Intune is included as part of the Microsoft Enterprise Mobility Suite, a costeffective wayto use the Microsoft Enterprise Mobility cloud services for all of your employees.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/microsoft-intune.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/microsoft-intune.jpg" alt="microsoft-intune">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>With the proliferation of mobile devices in the workplace, employees can, and do, work from just about anywhere. To stay productive, this mobile workforce demands consistent access to corporate resources and data from any location from any device. This trend has introduced significant challenges for IT administrators who want to enable enterprise mobility while ensuring that corporate resources are protected from unauthorized access. By using Microsoft Intune, you can manage applications and devices from the cloud.  Microsoft Intune is included as part of the Microsoft Enterprise Mobility Suite, a costeffective wayto use the Microsoft Enterprise Mobility cloud services for all of your employees.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h4>Implement Modern Device Services </h4>
                            <h6>Implement Mobile Device Management (MDM) </h6>
                            <ul>
                                <li>plan for MDM </li>
                                <li>configure MDM integration with Azure AD </li>
                                <li>set device enrollment limit for users </li>
                            </ul>
                        </div>
                        <div class="topic-content">
                            <h6>Manage device compliance </h6>
                            <ul>
                                <li>plan for device compliance </li>
                                <li>design Conditional Access Policies </li>
                                <li>create Conditional Access Policies </li>
                                <li>configure device compliance policy</li>
                                <li>manage Conditional Access Policies </li>
                            </ul>
                            <h6>Plan for devices and apps </h6>
                            <ul>
                                <li>create and configure Microsoft Store for Business </li>
                                <li>plan app deployment </li>
                                <li>plan device co-management </li>
                                <li>plan device monitoring </li>
                                <li>plan for device profiles </li>
                                <li>plan for Mobile Application Management </li>
                                <li>plan mobile device security </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/microsoft-intune.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>Basic Knowledge for Microsoft Servers and Networking </li>
                                <li>Windows 10 Basics or Windows 10 settings </li>
                                <li>Mobile devices such as Android,iOS,MAC Device how the settings works should be must pre-requirement as we deal with those settings in this course </li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>Candidates for this exam are Microsoft 365 Enterprise Administrators who take part in evaluating, planning, migrating, deploying, and managing Microsoft 365 services. They perform Microsoft 365 tenant management tasks for an enterprise, including its identities, security, compliance, and supporting technologies</li>
                            <li>Candidates have a working knowledge of Microsoft 365 workloads and should have been an administrator for at least one Microsoft 365 workload (Exchange, SharePoint, Skype for Business, Windows as a Service)</li>
                            <li>Candidates also have a working knowledge of networking, server administration, and IT fundamentals such as DNS, Active Directory, and PowerShell</li>
                        </ul>
                    </div>
                </div>
            </div>
