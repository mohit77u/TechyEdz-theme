        ...
        <div class="row">
            <div class="col-sm-8">
                <div class="course-details">
                    <h2>RPA UiPath Certification Training </h2>
                    <div class="ratings">
                        <div class="star">
                        ...
                        <p>4975 Ratings (4.8)</p>
                    </div>
                    <p class="para">Uipath is one of the best Robotic Process Automation tools which is a complete software solution which helps to automates an organization by reducing human stress and saving time. Uipath Training makes an aspirant to work very quick with easy process by using diagrams and flowcharts in the Uipath studio. We start off by learning what RPA is, how to choose the best processes fit for RPA, installing UiPath onto your machine and then building your first simple robot. We then explore UiPath Studio learning all about the user interface to get a basic understanding on how to use UiPath Studio. Once we cover all the basics we then take a deep dive into building real-world software robots ranging in complexity from beginner to advanced.</p>
                    <button class="course-btn2" data-toggle="modal" data-target="#exampleModalCenter">Free demo classes</button>
                    <a href="<?php echo get_template_directory_uri(); ?>/pdf/rpa-uipath.pdf" download><button class="course-btn1"><i class="fa fa-file-pdf-o"></i>Download PDF</a></button>
                </div>
            </div>
            <div class="col-sm-4">
                <img src="<?php echo get_template_directory_uri(); ?>/images/courses/rpa-uipath.jpg" alt="rpa-uipath">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        <div class="topic-content">
                            ...
                            <p>Uipath is one of the best Robotic Process Automation tools which is a complete software solution which helps to automates an organization by reducing human stress and saving time. Uipath Training makes an aspirant to work very quick with easy process by using diagrams and flowcharts in the Uipath studio. We start off by learning what RPA is, how to choose the best processes fit for RPA, installing UiPath onto your machine and then building your first simple robot. We then explore UiPath Studio learning all about the user interface to get a basic understanding on how to use UiPath Studio. Once we cover all the basics we then take a deep dive into building real-world software robots ranging in complexity from beginner to advanced.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    <div class="content">
                        ...
                        <div class="topic-content">
                            <h6>Introduction </h6>
                            <ul>
                                <li>Introduction to UIPath’s Robotic Automation Framework </li>
                                <li>UIPath vs Blueprism vs Automation Anywhere </li>
                                <li>UIPath Tool Installation and Setup </li>
                                <li>Why UIPath?</li>
                            </ul>
                            <h6>Workflow Designer Panels </h6>
                            <ul>
                                <li>Ribbon </li>
                                <li>Universal Search Box </li>
                                <li>Activities Panel </li>
                                <li>Design Panel </li>
                                <li>Library Panel </li>
                                <li>Project Panel </li>
                            ...
                            <ul>
                                <li>Variables </li>
                                <li>DataTypes and Usage </li>
                                <li>Managing Arguments </li>
                            </ul>
                        </div>
                        <h5 class="see-text">To see the full course content <a href="<?php echo get_template_directory_uri(); ?>/pdf/rpa-uipath.pdf" download>Download now</a></h5>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="about">
                        ...
                        <div class="topic-content">
                            <ul>
                                <li>Have basic-level computer literacy; familiarity with MS Excel, PDFs, notepad, websites and desktop applications</li>
                                <li>Basic knowledge of .NET Programming is enough to learn Uipath </li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="topic-content">
                        ...
                        <ul>
                            <li>Beginners to UiPath curious about Robotic Process Automation (RPA)</li>
                            <li>Anyone who wants to land a high-paying RPA developer / architect / analyst job in the near future</li>
                            <li>White-collar employees wanting to save time, reduce errors, and improve efficiency by automating common business tasks</li>
                            <li>Business leaders who want to automate business processes</li>
                        </ul>
                    </div>
                </div>
            </div>
